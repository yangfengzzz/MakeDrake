...
public:
    ...
    explicit Parallelism(int num_threads) : num_threads_(num_threads) { DRAKE_THROW_UNLESS(num_threads >= 1); }
...
int ConfigureMaxNumThreads(const char* drake_num_threads, const char* omp_num_threads);
}  // namespace internal
