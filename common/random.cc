...
namespace drake {
std::unique_ptr<RandomGenerator::Engine> RandomGenerator::CreateEngine(result_type seed) {
...
template AutoDiffXd CalcProbabilityDensity<AutoDiffXd>(RandomDistribution,
