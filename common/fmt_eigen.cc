...
template <typename T>
using FormatterEigenRef = Eigen::Ref<const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>>;
...
template std::string FormatEigenMatrix<double>(const FormatterEigenRef<double>& matrix);
template std::string FormatEigenMatrix<float>(const FormatterEigenRef<float>& matrix);
template std::string FormatEigenMatrix<std::string>(const FormatterEigenRef<std::string>& matrix);
