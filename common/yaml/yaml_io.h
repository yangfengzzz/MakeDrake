...
void WriteFile(std::string_view function_name, const std::string& filename, const std::string& data);
...
static Serializable LoadYamlFile(const std::string& filename,
                                 ...
                                 const std::optional<Serializable>& defaults,
                                 const std::optional<LoadYamlOptions>& options) {
    internal::Node node = internal::YamlReadArchive::LoadFileAsNode(filename, child_name);
...
static Serializable LoadYamlString(const std::string& data,
                                   ...
                                   const std::optional<Serializable>& defaults,
                                   const std::optional<LoadYamlOptions>& options) {
    internal::Node node = internal::YamlReadArchive::LoadStringAsNode(data, child_name);
    return internal::LoadNode(std::move(node), defaults, options);
}
...
void SaveYamlFile(const std::string& filename,
                  ...
                  const std::optional<std::string>& child_name,
                  const std::optional<Serializable>& defaults) {
    internal::WriteFile("SaveYamlFile", filename, SaveYamlString(data, child_name, defaults));
}
