...
struct ArrayStruct {
    ...
    explicit ArrayStruct(const std::array<double, 3>& value_in) : value(value_in) {}
...
struct VectorStruct {
    ...
    explicit VectorStruct(const std::vector<double>& value_in) : value(value_in) {}
...
struct MapStruct {
    ...
    explicit MapStruct(const std::map<std::string, double>& value_in) : value(value_in.begin(), value_in.end()) {}
...
struct UnorderedMapStruct {
    ...
    explicit UnorderedMapStruct(const std::unordered_map<std::string, double>& value_in)
...
struct OptionalStruct {
    ...
    explicit OptionalStruct(const double value_in) : OptionalStruct(std::optional<double>(value_in)) {}

    explicit OptionalStruct(const std::optional<double>& value_in) : value(value_in) {}
...
struct OptionalStructNoDefault {
    ...
    explicit OptionalStructNoDefault(const std::optional<double>& value_in) : value(value_in) {}
...
struct EigenStruct {
    ...
    explicit EigenStruct(const Eigen::Matrix<double, Rows, Cols>& value_in) : value(value_in) {}
...
bool operator==(const EigenStruct<Rows, Cols>& a, const EigenStruct<Rows, Cols>& b) {
...
using EigenMatrixUpTo6Struct = EigenStruct<Eigen::Dynamic, Eigen::Dynamic, 6, 6>;

using Variant4 = std::variant<std::string, double, DoubleStruct, EigenVecStruct>;
...
using PrimitiveVariant = std::variant<std::vector<double>, bool, int, double, std::string>;
