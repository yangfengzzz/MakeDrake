...
public:
    ...
    const trajectories::Trajectory<T>& time_scaling() const { return *time_scaling_; }
...
private:
    ...
    bool do_has_derivative() const override { return path_->has_derivative() && time_scaling_->has_derivative(); }
