...
public:
    ...
    const std::vector<MatrixX<T>>& control_points() const { return control_points_; }
...
private:
    ...
    std::unique_ptr<trajectories::Trajectory<T>> DoMakeDerivative(int derivative_order) const override;
