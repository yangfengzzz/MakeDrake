...
GTEST_TEST(RpcPipeTempDirectoryTest, TestTmpdirSet) {
    ...
    const std::string temp_directory_with_test_tmpdir_set = GetRpcPipeTempDirectory();
...
GTEST_TEST(RpcPipeTempDirectoryTest, TestTmpdirUnset) {
    ...
    const std::string temp_directory_with_test_tmpdir_unset = GetRpcPipeTempDirectory();
