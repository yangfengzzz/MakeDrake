...
public:
    ...
    AutoDiff(double value, Eigen::Index size, Eigen::Index offset) : value_{value}, partials_{size, offset} {}
    ...
    road. */
    const Eigen::VectorXd& derivatives() const { return partials_.make_const_xpr(); }
...
// clang-format off
#include "common/ad/internal/standard_operations.h"
#include "common/ad/internal/eigen_specializations.h"
// clang-format on
