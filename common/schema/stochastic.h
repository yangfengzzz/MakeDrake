...
using DistributionVectorVariant = std::variant<
        ...
        std::conditional_t<(Size == Eigen::Dynamic || Size == 1), Uniform, internal::InvalidVariantSelection<Uniform>>>;
...
DRAKE_DECLARE_TEMPLATE_INSTANTIATIONS_ON_ALL_SIZES(std::unique_ptr<DistributionVector> ToDistributionVector)
DRAKE_DECLARE_TEMPLATE_INSTANTIATIONS_ON_ALL_SIZES(bool IsDeterministic)
DRAKE_DECLARE_TEMPLATE_INSTANTIATIONS_ON_ALL_SIZES(Eigen::VectorXd GetDeterministicValue)
