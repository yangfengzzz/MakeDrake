...
class MemcpyMovable {
public:
    explicit MemcpyMovable(string name) : name_{make_unique<string>(move(name))} {}
    ...
    struct EqualTo {
        bool operator()(const MemcpyMovable& v1, const MemcpyMovable& v2) const { return v1 == v2; }
    };
...
public:
    ...
    struct InvariantsHold {
        bool operator()(const NotMemcpyMovable& v1, const NotMemcpyMovable& v2) const {
