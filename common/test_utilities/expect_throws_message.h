...
#define DRAKE_EXPECT_THROWS_MESSAGE_HELPER(expression, regexp, must_throw, fatal_failure) \
    do {                                                                                  \
        try {                                                                             \
...
#define DRAKE_EXPECT_THROWS_MESSAGE(expression, regexp) \
    DRAKE_EXPECT_THROWS_MESSAGE_HELPER(expression, regexp, true /*must_throw*/, false /*non-fatal*/)

#define DRAKE_ASSERT_THROWS_MESSAGE(expression, regexp) \
    DRAKE_EXPECT_THROWS_MESSAGE_HELPER(expression, regexp, true /*must_throw*/, true /*fatal*/)

#define DRAKE_EXPECT_THROWS_MESSAGE_IF_ARMED(expression, regexp)                                        \
    DRAKE_EXPECT_THROWS_MESSAGE_HELPER(expression, regexp, ::drake::kDrakeAssertIsArmed /*must_throw*/, \
                                       false /*non-fatal*/)

#define DRAKE_ASSERT_THROWS_MESSAGE_IF_ARMED(expression, regexp) \
    DRAKE_EXPECT_THROWS_MESSAGE_HELPER(expression, regexp, ::drake::kDrakeAssertIsArmed /*must_throw*/, true /*fatal*/)
