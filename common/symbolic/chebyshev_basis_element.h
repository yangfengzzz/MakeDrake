...
public:
    ...
    explicit ChebyshevBasisElement(const std::map<Variable, int>& var_to_degree_map);
     ...
     */
    [[nodiscard]] std::map<ChebyshevBasisElement, double> Differentiate(const Variable& var) const;
     ...
     */
    [[nodiscard]] std::map<ChebyshevBasisElement, double> Integrate(const Variable& var) const;
     ...
     * (442, T₁(z)).
     */
    [[nodiscard]] std::pair<double, ChebyshevBasisElement> EvaluatePartial(const Environment& env) const;

    /** Implements the @ref hash_append concept. */
    template <class HashAlgorithm>
    friend void hash_append(HashAlgorithm& hasher, const ChebyshevBasisElement& item) noexcept {
...
template <>
struct hash<drake::symbolic::ChebyshevBasisElement> : public drake::DefaultHash {};
}  // namespace std
...
template <>
struct NumTraits<drake::symbolic::ChebyshevBasisElement> : GenericNumTraits<drake::symbolic::ChebyshevBasisElement> {
...
namespace fmt {
template <>
struct formatter<drake::symbolic::ChebyshevBasisElement> : drake::ostream_formatter {};
}  // namespace fmt
