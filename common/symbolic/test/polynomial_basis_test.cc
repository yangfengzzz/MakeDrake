...
TEST_F(ComputePolynomialBasisUpToDegreeTest, ChebyshevAnyParity) {
    ...
    const Vector1<ChebyshevBasisElement> result0 =
            ComputePolynomialBasisUpToDegree<1, ChebyshevBasisElement>(Variables({x_}), 0, internal::DegreeType::kAny);
    ...
    const Vector2<ChebyshevBasisElement> result1 =
            ComputePolynomialBasisUpToDegree<2, ChebyshevBasisElement>(Variables({x_}), 1, internal::DegreeType::kAny);
    ...
    const Vector3<ChebyshevBasisElement> result2 =
            ComputePolynomialBasisUpToDegree<3, ChebyshevBasisElement>(Variables({x_}), 2, internal::DegreeType::kAny);
    ...
    const VectorX<ChebyshevBasisElement> result3 =
            ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(Variables({x_, y_}), 0,
                                                                                    internal::DegreeType::kAny);
    ...
    const VectorX<ChebyshevBasisElement> result4 =
            ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(Variables({x_, y_}), 1,
                                                                                    internal::DegreeType::kAny);
    ...
    const VectorX<ChebyshevBasisElement> result5 =
            ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(Variables({x_, y_}), 2,
                                                                                    internal::DegreeType::kAny);
    ...
    const VectorX<ChebyshevBasisElement> result6 =
            ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(Variables({x_, y_}), 3,
                                                                                    internal::DegreeType::kAny);
    ...
    const VectorX<ChebyshevBasisElement> result7 =
            ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(Variables({x_, y_, z_}), 2,
                                                                                    internal::DegreeType::kAny);
    ...
    const VectorX<ChebyshevBasisElement> result8 =
            ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(Variables({x_, y_, z_}), 3,
                                                                                    internal::DegreeType::kAny);
...
TEST_F(ComputePolynomialBasisUpToDegreeTest, ChebyshevEvenParity) {
    ...
    // is [1].
    for (int degree : {0, 1}) {
        const auto result = ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(
...
TEST_F(ComputePolynomialBasisUpToDegreeTest, ChebyshevOddParity) {
    ...
    const auto result1 = ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(
    ...
    // is [T1(x)].
    for (int degree : {1, 2}) {
        const auto result2 = ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(
    ...
    // is [T1(x), T3(x)].
    for (int degree : {3, 4}) {
        const auto result4 = ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(
                Variables({x_}), degree, internal::DegreeType::kOdd);
    ...
    for (int degree : {3, 4}) {
        const auto result5 = ComputePolynomialBasisUpToDegree<Eigen::Dynamic, ChebyshevBasisElement>(
...
TEST_F(ComputePolynomialBasisUpToDegreeTest, MonomialAnyParity) {
    ...
    // y^2]
    const auto result1 = ComputePolynomialBasisUpToDegree<Eigen::Dynamic, Monomial>(Variables({x_, y_}), 2,
                                                                                    internal::DegreeType::kAny);
