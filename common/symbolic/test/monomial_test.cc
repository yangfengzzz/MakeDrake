...
TEST_F(MonomialTest, ConstructFromVariablesAndExponents) {
    ...
    DRAKE_EXPECT_THROWS_MESSAGE(Monomial(vars_xyz, Eigen::Vector3i(2, 0, -1)), "The exponent is negative.");
}
...
TEST_F(MonomialTest, MonomialBasisXYZ2) {
    const drake::VectorX<Monomial> basis1{MonomialBasis({var_x_, var_y_, var_z_}, 2)};
...
TEST_F(MonomialTest, MonomialBasisXYZ3) {
    const drake::VectorX<Monomial> basis1{MonomialBasis({var_x_, var_y_, var_z_}, 3)};
...
TEST_F(MonomialTest, MonomialBasisXYZW3) {
    const drake::VectorX<Monomial> basis1{MonomialBasis({var_x_, var_y_, var_z_, var_w_}, 3)};
...
TEST_F(MonomialTest, EvenDegreeMonomialBasisXY01) {
    const drake::VectorX<Monomial> basis1{EvenDegreeMonomialBasis({var_x_, var_y_}, 0)};
    const drake::VectorX<Monomial> basis2{EvenDegreeMonomialBasis({var_x_, var_y_}, 1)};
    drake::Vector1<Monomial> expected;
...
TEST_F(MonomialTest, EvenDegreeMonomialBasisXY23) {
    const drake::VectorX<Monomial> basis1{EvenDegreeMonomialBasis({var_x_, var_y_}, 2)};
    const drake::VectorX<Monomial> basis2{EvenDegreeMonomialBasis({var_x_, var_y_}, 3)};
...
TEST_F(MonomialTest, EvenDegreeMonomialBasisXYZ45) {
    const drake::VectorX<Monomial> basis1{EvenDegreeMonomialBasis({var_x_, var_y_, var_z_}, 4)};
    const drake::VectorX<Monomial> basis2{EvenDegreeMonomialBasis({var_x_, var_y_, var_z_}, 5)};
...
TEST_F(MonomialTest, OddDegreeMonomialBasisXY12) {
    const drake::VectorX<Monomial> basis1{OddDegreeMonomialBasis({var_x_, var_y_}, 1)};
    const drake::VectorX<Monomial> basis2{OddDegreeMonomialBasis({var_x_, var_y_}, 2)};
    drake::Vector2<Monomial> expected;

    // OddDegreeMonomialBasis({x, y}, 1) = {x, y}.
    expected << Monomial{{{var_x_, 1}, {var_y_, 0}}}, Monomial{{{var_x_, 0}, {var_y_, 1}}};
...
TEST_F(MonomialTest, OddDegreeMonomialBasisXY34) {
    const drake::VectorX<Monomial> basis1{OddDegreeMonomialBasis({var_x_, var_y_}, 3)};
    const drake::VectorX<Monomial> basis2{OddDegreeMonomialBasis({var_x_, var_y_}, 4)};
    drake::Vector6<Monomial> expected;
...
TEST_F(MonomialTest, OddDegreeMonomialBasisXYZ34) {
    const drake::VectorX<Monomial> basis1{OddDegreeMonomialBasis({var_x_, var_y_, var_z_}, 3)};
    const drake::VectorX<Monomial> basis2{OddDegreeMonomialBasis({var_x_, var_y_, var_z_}, 4)};
...
TEST_F(MonomialTest, ToMonomialException4) {
    ...
    // initializer list.
    DRAKE_EXPECT_THROWS_MESSAGE((Monomial{{{var_x_, -1}}}), "The exponent is negative.");
}
...
void CheckEvaluateBatch(const Monomial& dut,
...
TEST_F(MonomialTest, EvaluateBatchException) {
    ...
    DRAKE_EXPECT_THROWS_MESSAGE(
            monomial.Evaluate(Vector3<symbolic::Variable>(var_x_, var_x_, var_y_), Eigen::Vector3d(1, 2, 3)),
            ".* vars contains repeated variables.");

    DRAKE_EXPECT_THROWS_MESSAGE(monomial.Evaluate(Vector2<symbolic::Variable>(var_x_, var_z_), Eigen::Vector2d(2, 3)),
