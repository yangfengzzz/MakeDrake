#include "common/symbolic/generic_polynomial.h"

#include <gtest/gtest.h>

#include "common/symbolic/polynomial_basis.h"
...
TEST_F(SymbolicGenericPolynomialTest, ConstructFromSingleElement) {
    const GenericPolynomial<ChebyshevBasisElement> p1(ChebyshevBasisElement({{var_x_, 1}, {var_y_, 2}}));
    EXPECT_EQ(p1.basis_element_to_coefficient_map().size(), 1);
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(ChebyshevBasisElement({{var_x_, 1}, {var_y_, 2}})),
                 Expression(1));
}

TEST_F(SymbolicGenericPolynomialTest, ConstructFromExpressionMonomialBasis) {
    // p1 = 2x²+3x
    const GenericPolynomial<MonomialBasisElement> p1(var_x_ * var_x_ * 2 + 3 * var_x_);
    EXPECT_EQ(p1.basis_element_to_coefficient_map().size(), 2);
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(MonomialBasisElement(var_x_, 2)), Expression(2));
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(MonomialBasisElement(var_x_)), Expression(3));

    // p2 = 4xy+5y²+3xz³+2
    const GenericPolynomial<MonomialBasisElement> p2(4 * var_x_ * var_y_ + 5 * pow(var_y_, 2) +
                                                     3 * var_x_ * pow(var_z_, 3) + 2);
    EXPECT_EQ(p2.basis_element_to_coefficient_map().size(), 4);
    EXPECT_PRED2(ExprEqual, p2.basis_element_to_coefficient_map().at(MonomialBasisElement({{var_x_, 1}, {var_y_, 1}})),
                 Expression(4));
    EXPECT_PRED2(ExprEqual, p2.basis_element_to_coefficient_map().at(MonomialBasisElement(var_y_, 2)), Expression(5));
    EXPECT_PRED2(ExprEqual, p2.basis_element_to_coefficient_map().at(MonomialBasisElement({{var_x_, 1}, {var_z_, 3}})),
                 Expression(3));
    EXPECT_PRED2(ExprEqual, p2.basis_element_to_coefficient_map().at(MonomialBasisElement()), Expression(2));
}
...
TEST_F(SymbolicGenericPolynomialTest, ConstructFromExpressionChebyshevBasis) {
    ...
    EXPECT_EQ(p1.basis_element_to_coefficient_map().size(), 1);
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(ChebyshevBasisElement()), Expression(1.));

    // T₂(x)=2x²−1
    const GenericPolynomial<ChebyshevBasisElement> p2(2 * pow(var_x_, 2) - 1);
    EXPECT_EQ(p2.basis_element_to_coefficient_map().size(), 1);
    EXPECT_PRED2(ExprEqual, p2.basis_element_to_coefficient_map().at(ChebyshevBasisElement(var_x_, 2)), Expression(1.));

    // T₂(x)T₃(y)=(2x²−1)(4y³−3y)
    const GenericPolynomial<ChebyshevBasisElement> p3((2 * pow(var_x_, 2) - 1) * (4 * pow(var_y_, 3) - 3 * var_y_));
    EXPECT_EQ(p3.basis_element_to_coefficient_map().size(), 1);
    EXPECT_PRED2(ExprEqual, p3.basis_element_to_coefficient_map().at(ChebyshevBasisElement({{var_x_, 2}, {var_y_, 3}})),
                 Expression(1.));

    // 2T₂(x)T₃(y)+T₁(x)T₂(y)=2(2x²−1)(4y³−3y)+x(2y²−1)
    //                       = 16x²y³−8y³−12x²y+6y+2xy²−x
    const GenericPolynomial<ChebyshevBasisElement> p4(16 * pow(var_x_, 2) * pow(var_y_, 3) - 8 * pow(var_y_, 3) -
                                                      12 * pow(var_x_, 2) * var_y_ + 6 * var_y_ +
                                                      2 * var_x_ * pow(var_y_, 2) - var_x_);
    EXPECT_EQ(p4.basis_element_to_coefficient_map().size(), 2);
    EXPECT_PRED2(ExprEqual, p4.basis_element_to_coefficient_map().at(ChebyshevBasisElement({{var_x_, 2}, {var_y_, 3}})),
                 Expression(2.));
    EXPECT_PRED2(ExprEqual, p4.basis_element_to_coefficient_map().at(ChebyshevBasisElement({{var_x_, 1}, {var_y_, 2}})),
                 Expression(1.));

    // 3T₀()+2T₁(x)+4T₂(x)+3T₃(x) = 3+2x+8x²−4+12x³−9x
    //                            = 12x³+8x²−7x−1
    const GenericPolynomial<ChebyshevBasisElement> p5(12 * pow(var_x_, 3) + 8 * pow(var_x_, 2) - 7 * var_x_ - 1);
    EXPECT_EQ(p5.basis_element_to_coefficient_map().size(), 4);
    EXPECT_PRED2(ExprEqual, p5.basis_element_to_coefficient_map().at(ChebyshevBasisElement()), Expression(3));
    EXPECT_PRED2(ExprEqual, p5.basis_element_to_coefficient_map().at(ChebyshevBasisElement(var_x_)), Expression(2));
    EXPECT_PRED2(ExprEqual, p5.basis_element_to_coefficient_map().at(ChebyshevBasisElement(var_x_, 2)), Expression(4));
    EXPECT_PRED2(ExprEqual, p5.basis_element_to_coefficient_map().at(ChebyshevBasisElement(var_x_, 3)), Expression(3));
    ...
    const GenericPolynomial<ChebyshevBasisElement> p6(8 * pow(var_x_, 3) - 6 * x_ + 1);
    EXPECT_EQ(p6.basis_element_to_coefficient_map().size(), 2);
    EXPECT_PRED2(ExprEqual, p6.basis_element_to_coefficient_map().at(ChebyshevBasisElement(var_x_, 3)), Expression(2));
    EXPECT_PRED2(ExprEqual, p6.basis_element_to_coefficient_map().at(ChebyshevBasisElement()), Expression(1));
}

TEST_F(SymbolicGenericPolynomialTest, ConstructFromExpressionIndeterminatesMonomialBasis) {
    // Test constructing GenericPolynomial<MonomialBasisElement> from expression
    // and indeterminates

    // e=a²x²+(a+b)xy²+c, indeterminates = {x, y, z}.
    const GenericPolynomial<MonomialBasisElement> p1(
            pow(var_a_, 2) * pow(var_x_, 2) + (a_ + b_) * var_x_ * pow(var_y_, 2) + c_, indeterminates_);
    ...
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(MonomialBasisElement(var_x_, 2)), pow(var_a_, 2));
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(MonomialBasisElement({{var_x_, 1}, {var_y_, 2}})),
                 a_ + b_);
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(MonomialBasisElement()), c_);
}

TEST_F(SymbolicGenericPolynomialTest, ConstructFromExpressionIndeterminatesChebyshevBasis) {
    ...
    const GenericPolynomial<ChebyshevBasisElement> p1(
            a_ * (2 * pow(var_x_, 2) - 1) + (a_ + b_) * x_ * (2 * pow(var_y_, 2) - 1) + c_, indeterminates_);
    EXPECT_EQ(p1.basis_element_to_coefficient_map().size(), 3);
    EXPECT_EQ(p1.indeterminates(), indeterminates_);
    EXPECT_EQ(p1.decision_variables(), Variables({var_a_, var_b_, var_c_}));
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(ChebyshevBasisElement(var_x_, 2)), a_);
    EXPECT_PRED2(ExprEqual,
                 p1.basis_element_to_coefficient_map().at(ChebyshevBasisElement({{var_x_, 1}, {var_y_, 2}})).Expand(),
                 a_ + b_);
    EXPECT_PRED2(ExprEqual, p1.basis_element_to_coefficient_map().at(ChebyshevBasisElement()), c_);
}

TEST_F(SymbolicGenericPolynomialTest, ConstructFromExpressionExpandMonomialBasis) {
    ...
    for (const Expression& e : exprs_) {
        ...
        const Expression expr_from_polynomial{GenericPolynomial<MonomialBasisElement>{e}.ToExpression()};
        EXPECT_PRED2(ExprEqual, expanded_expr, expr_from_polynomial);
    }
}

TEST_F(SymbolicGenericPolynomialTest, ConstructFromExpressionExpandChebyshevBasis) {
    // Expression -------------------> Polynomial
    //     | .Expand()                     | .ToExpression()
    //    \/                              \/
    // Expanded Expression     ==      Expression
    for (const Expression& e : exprs_) {
        const Expression expanded_expr{e.Expand()};
        const Expression expr_from_polynomial{GenericPolynomial<ChebyshevBasisElement>{e}.ToExpression()};
        EXPECT_PRED2(ExprEqual, expanded_expr, expr_from_polynomial);
    }
}

TEST_F(SymbolicGenericPolynomialTest, ConstructorFromExpressionAndIndeterminates1) {
    const GenericPolynomial<MonomialBasisElement> p1{1.0, var_xyz_};  // p₁ = 1.0,
    EXPECT_EQ(p1.basis_element_to_coefficient_map(),
              GenericPolynomial<MonomialBasisElement>::MapType({{MonomialBasisElement{}, Expression(1.0)}}));
    // p₂ = ax + by + cz + 10
    const GenericPolynomial<MonomialBasisElement> p2{a_ * x_ + b_ * y_ + c_ * z_ + 10, var_xyz_};
    EXPECT_EQ(p2.basis_element_to_coefficient_map(),
              GenericPolynomial<MonomialBasisElement>::MapType({{MonomialBasisElement{var_x_}, a_},
    ...
    const GenericPolynomial<MonomialBasisElement> p3{
            3 * a_ * pow(b_, 2) * pow(x_, 2) * y_ - b_ * c_ * pow(z_, 3) + pow(b_, 2), var_xyz_};
    EXPECT_EQ(p3.basis_element_to_coefficient_map(),
              GenericPolynomial<MonomialBasisElement>::MapType(
                      // x²y ↦ 3ab²
                      {{MonomialBasisElement{{{var_x_, 2}, {var_y_, 1}}}, 3 * a_ * pow(b_, 2)},
                       // z³ ↦ -bc
    ...
    // p₄ = 3ab²*x²y - bc*x³
    const GenericPolynomial<MonomialBasisElement> p4{3 * a_ * pow(b_, 2) * pow(x_, 2) * y_ - b_ * c_ * pow(x_, 3),
                                                     var_xyz_};
    ...
    EXPECT_EQ(p5.basis_element_to_coefficient_map().at(MonomialBasisElement(var_x_, 3)), pow(a_, 3));
}

TEST_F(SymbolicGenericPolynomialTest, ConstructorFromExpressionAndIndeterminates2) {
    ...
    EXPECT_EQ(p1.basis_element_to_coefficient_map(), p2.basis_element_to_coefficient_map());
}
...
void CheckAdditionPolynomialPolynomial(const std::vector<Expression>& exprs, double tol) {
    ...
    for (const Expression& e1 : exprs) {
        for (const Expression& e2 : exprs) {
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>,
                         (GenericPolynomial<BasisElement>{e1} + GenericPolynomial<BasisElement>{e2}),
    ...
    for (const Expression& e1 : exprs) {
        for (const Expression& e2 : exprs) {
            ...
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>, p,
                         GenericPolynomial<BasisElement>(e1 + e2, p.indeterminates()), tol);
        }
    }
}

TEST_F(SymbolicGenericPolynomialTest, AdditionPolynomialPolynomialMonomialBasis) {
    CheckAdditionPolynomialPolynomial<MonomialBasisElement>(exprs_, 0.);
}

TEST_F(SymbolicGenericPolynomialTest, AdditionPolynomialPolynomialChebyshevBasis) {
    CheckAdditionPolynomialPolynomial<ChebyshevBasisElement>(exprs_, 1E-10);
}

template <typename BasisElement>
void CheckAdditionPolynomialBasisElement(const std::vector<Expression>& exprs,
    ...
    for (const Expression& e : exprs) {
        for (int i = 0; i < basis_elements.size(); ++i) {
            ...
            EXPECT_PRED2(ExprEqual, (GenericPolynomial<BasisElement>(e) + m).ToExpression(),
                         (e + m.ToExpression()).Expand());
            EXPECT_PRED2(ExprEqual, (m + GenericPolynomial<BasisElement>(e)).ToExpression(),
    ...
    for (const Expression& e : exprs) {
        for (int i = 0; i < basis_elements.size(); ++i) {
            ...
            p += m;
            EXPECT_PRED2(ExprEqual, p.ToExpression(), (e + m.ToExpression()).Expand());
        }
    }
}
...
TEST_F(SymbolicGenericPolynomialTest, AdditionPolynomialChebyshevBasisElement) {
    CheckAdditionPolynomialBasisElement<ChebyshevBasisElement>(exprs_, chebyshev_basis_);
}

template <typename BasisElement>
void CheckAdditionPolynomialDouble(const std::vector<Expression>& exprs, const std::vector<double>& doubles) {
    //   (Polynomial(e) + c).ToExpression() = (e + c).Expand()
    //   (c + Polynomial(e)).ToExpression() = (c + e).Expand()
    for (const Expression& e : exprs) {
        for (const double c : doubles) {
            EXPECT_PRED2(ExprEqual, (GenericPolynomial<BasisElement>(e) + c).ToExpression(), (e + c).Expand());
            EXPECT_PRED2(ExprEqual, (c + GenericPolynomial<BasisElement>(e)).ToExpression(), (c + e).Expand());
        }
    }
...
template <typename BasisElement>
void CheckAdditionPolynomialVariable(const std::vector<Expression>& exprs, const Variables& vars) {
    //   (Polynomial(e) + v).ToExpression() = (e + v).Expand()
    //   (v + Polynomial(e)).ToExpression() = (v + e).Expand()
    for (const Expression& e : exprs) {
        for (const Variable& v : vars) {
            EXPECT_PRED2(ExprEqual, (GenericPolynomial<BasisElement>(e) + v).ToExpression(), (e + v).Expand());
            EXPECT_PRED2(ExprEqual, (v + GenericPolynomial<BasisElement>(e)).ToExpression(), (v + e).Expand());
        }
    }
...
TEST_F(SymbolicGenericPolynomialTest, AdditionPolynomialVariableChebyshevBasis) {
    CheckAdditionPolynomialVariable<ChebyshevBasisElement>(exprs_, var_xyz_);
}

template <typename BasisElement>
void CheckSubtractionPolynomialPolynomial(const std::vector<Expression>& exprs, double tol) {
    // (Polynomial(e₁) - Polynomial(e₂)) = Polynomial(e₁ - e₂)
    for (const Expression& e1 : exprs) {
        for (const Expression& e2 : exprs) {
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>,
    ...
    for (const Expression& e1 : exprs) {
        for (const Expression& e2 : exprs) {
            GenericPolynomial<BasisElement> p{e1};
            p -= GenericPolynomial<BasisElement>{e2};
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>, p, GenericPolynomial<BasisElement>(e1 - e2), tol);
        }
    }
}

TEST_F(SymbolicGenericPolynomialTest, SubtractionPolynomialPolynomialMonomialBasis) {
    CheckSubtractionPolynomialPolynomial<MonomialBasisElement>(exprs_, 0.);
}

TEST_F(SymbolicGenericPolynomialTest, SubtractionPolynomialPolynomialChebyshevBasis) {
    CheckSubtractionPolynomialPolynomial<ChebyshevBasisElement>(exprs_, 1E-15);
}

template <typename BasisElement>
void CheckSubtractionPolynomialBasisElement(const std::vector<Expression>& exprs,
                                            const VectorX<BasisElement>& basis_elements) {
    // (Polynomial(e) - m).ToExpression() = (e - m.ToExpression()).Expand()
    // (m - Polynomial(e)).ToExpression() = (m.ToExpression() - e).Expand()
    for (const Expression& e : exprs) {
...
template <typename BasisElement>
void CheckSubtractionPolynomialDouble(const std::vector<Expression>& exprs, const std::vector<double>& doubles) {
    // (Polynomial(e) - c).ToExpression() = (e - c).Expand()
    // (c - Polynomial(e)).ToExpression() = (c - e).Expand()
    for (const Expression& e : exprs) {
        for (const double c : doubles) {
...
TEST_F(SymbolicGenericPolynomialTest, SubtractionPolynomialDoubleMonomialBasis) {
    CheckSubtractionPolynomialDouble<MonomialBasisElement>(exprs_, doubles_);
}

TEST_F(SymbolicGenericPolynomialTest, SubtractionPolynomialDoubleChebyshevBasis) {
    CheckSubtractionPolynomialDouble<ChebyshevBasisElement>(exprs_, doubles_);
}

template <typename BasisElement>
void CheckSubtractionBasisElementBasisElement(const VectorX<BasisElement>& basis_elements) {
...
template <typename BasisElement>
void CheckSubtractionBasisElementDouble(const VectorX<BasisElement>& basis_elements,
    ...
    for (int i = 0; i < basis_elements.size(); ++i) {
        const BasisElement& m{basis_elements[i]};
        for (const double c : doubles) {
            EXPECT_PRED2(ExprEqual, (m - c).ToExpression().Expand(), (m.ToExpression() - c).Expand());
            EXPECT_PRED2(ExprEqual, (c - m).ToExpression().Expand(), (c - m.ToExpression()).Expand());
        }
    }
}
...
void CheckUnaryMinus(const std::vector<Expression>& exprs) {
    ...
    for (const Expression& e : exprs) {
        EXPECT_PRED2(ExprEqual, (-GenericPolynomial<BasisElement>(e)).ToExpression(), -(e.Expand()));
    }
}
...
TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialPolynomialMonoialBasis1) {
    CheckMultiplicationPolynomialPolynomial<MonomialBasisElement>(exprs_, 1E-12);
}

TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialPolynomialChebyshev1) {
    CheckMultiplicationPolynomialPolynomial<ChebyshevBasisElement>(exprs_, 1E-12);
}

template <typename BasisElement>
void CheckMultiplicationPolynomialBasisElement(const std::vector<Expression>& exprs,
                                               const VectorX<BasisElement>& basis_elements,
                                               double tol) {
    ...
    for (const Expression& e : exprs) {
        for (int i = 0; i < basis_elements.size(); ++i) {
            const BasisElement& m{basis_elements[i]};
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>, GenericPolynomial<BasisElement>(e) * m,
                         GenericPolynomial<BasisElement>(e * m.ToExpression()), tol);
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>,
                         GenericPolynomial<BasisElement>(m.ToExpression() * e), m * GenericPolynomial<BasisElement>(e),
                         tol);
        }
    }
...
TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialMonomial) {
    CheckMultiplicationPolynomialBasisElement<MonomialBasisElement>(exprs_, monomials_, 0.);
}

TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialChebyshev) {
    CheckMultiplicationPolynomialBasisElement<ChebyshevBasisElement>(exprs_, chebyshev_basis_, 1E-15);
}

template <typename BasisElement>
void CheckMultiplicationPolynomialDouble(const std::vector<Expression>& exprs, const std::vector<double>& doubles) {
    // (Polynomial(e) * c).ToExpression() = (e * c).Expand()
    // (c * Polynomial(e)).ToExpression() = (c * e).Expand()
    for (const Expression& e : exprs) {
        for (const double c : doubles) {
...
TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialDoubleMonomialBasis) {
    CheckMultiplicationPolynomialDouble<MonomialBasisElement>(exprs_, doubles_);
}

TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialDoubleChebyshevBasis) {
    CheckMultiplicationPolynomialDouble<ChebyshevBasisElement>(exprs_, doubles_);
}

template <typename BasisElement>
void CheckMultiplicationBasisElementDouble(const VectorX<BasisElement>& basis_elements,
                                           const std::vector<double>& doubles) {
    ...
    for (int i = 0; i < basis_elements.size(); ++i) {
        const BasisElement& m{basis_elements[i]};
        for (const double c : doubles) {
            EXPECT_PRED2(ExprEqual, (m * c).ToExpression(), (m.ToExpression() * c).Expand());
            EXPECT_PRED2(ExprEqual, (c * m).ToExpression(), (c * m.ToExpression()).Expand());
        }
    }
}
...
TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialPolynomialMonomialBasis2) {
...
TEST_F(SymbolicGenericPolynomialTest, MultiplicationPolynomialPolynomialChebyshevBasis2) {
    // Evaluates (1 + x) * (1 - x) to confirm that the cross term 0 * x is
    // erased from the product.
...
TEST_F(SymbolicGenericPolynomialTest, BinaryOperationBetweenPolynomialAndVariableMonomialBasis) {
    // p = 2a²x² + 3ax + 7.
    const GenericPolynomial<MonomialBasisElement> p{2 * pow(a_, 2) * pow(x_, 2) + 3 * a_ * x_ + 7, {var_x_}};
    ...
    // Checks addition.
    {
        ...
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(m_one), 7 + a_);
        ...
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(m_x), 3 * a_ + 1);
    }
    ...
    // Checks multiplication.
    {
        ...
        EXPECT_EQ(result1.indeterminates(), p.indeterminates());
        EXPECT_EQ(result1.basis_element_to_coefficient_map().size(), 3);
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(m_x_sq), 2 * pow(a_, 3));
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(m_x), 3 * pow(a_, 2));
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(m_one), 7 * a_);
        ...
        EXPECT_EQ(result3.indeterminates(), p.indeterminates());
        EXPECT_EQ(result3.basis_element_to_coefficient_map().size(), 3);
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(m_x_cube), 2 * pow(a_, 2));
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(m_x_sq), 3 * a_);
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(m_x), 7);
...
TEST_F(SymbolicGenericPolynomialTest, BinaryOperationBetweenPolynomialAndVariableChebyshevBasis) {
    // p = 2a²T₂(x)+3aT₁(x)+7T₀()
    const GenericPolynomial<ChebyshevBasisElement> p{{{ChebyshevBasisElement(var_x_, 2), 2 * pow(a_, 2)},
    ...
    // Checks addition.
    {
        ...
        EXPECT_EQ(result1.basis_element_to_coefficient_map().size(), 3);
        EXPECT_EQ(result1.indeterminates(), p.indeterminates());
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(t_zero), 7 + a_);
        ...
        EXPECT_EQ(result3.basis_element_to_coefficient_map().size(), 3);
        EXPECT_EQ(result3.indeterminates(), p.indeterminates());
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(t_x), 3 * a_ + 1);
    }
    ...
    // Checks multiplication.
    {
        ...
        EXPECT_EQ(result1.indeterminates(), p.indeterminates());
        EXPECT_EQ(result1.basis_element_to_coefficient_map().size(), 3);
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(t_x_sq), 2 * pow(a_, 3));
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(t_x), 3 * pow(a_, 2));
        EXPECT_PRED2(ExprEqual, result1.basis_element_to_coefficient_map().at(t_zero), 7 * a_);
        ...
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(t_x_cube), pow(a_, 2));
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(t_x_sq), 1.5 * a_);
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(t_x), 7 + pow(a_, 2));
        EXPECT_PRED2(ExprEqual, result3.basis_element_to_coefficient_map().at(t_zero), 1.5 * a_);
...
TEST_F(SymbolicGenericPolynomialTest, Pow) {
    // Test negative power
    DRAKE_EXPECT_THROWS_MESSAGE(pow(GenericPolynomial<MonomialBasisElement>(2 * x_), -1),
    ...
    EXPECT_EQ(result.basis_element_to_coefficient_map().at(ChebyshevBasisElement()), 1);
...
void CheckDivideByConstant(const std::vector<Expression>& exprs, double tol) {
    for (double v = -5.5; v <= 5.5; v += 1.0) {
        for (const Expression& e : exprs) {
            EXPECT_PRED3(test::GenericPolyAlmostEqual<BasisElement>, GenericPolynomial<BasisElement>(e) / v,
...
TEST_F(SymbolicGenericPolynomialTest, DifferentiateForMonomialBasis) {
    // p = 2a²bx² + 3bc²x + 7ac.
    const GenericPolynomial<MonomialBasisElement> p{{{MonomialBasisElement(var_x_, 2), 2 * pow(a_, 2) * b_},
                                                     {MonomialBasisElement(var_x_), 3 * b_ * pow(c_, 2)},
                                                     {MonomialBasisElement(), 7 * a_ * c_}}};
    // d/dx p = 4a²bx + 3bc²
    const GenericPolynomial<MonomialBasisElement> p_x{
            {{MonomialBasisElement(var_x_), 4 * pow(a_, 2) * b_}, {MonomialBasisElement(), 3 * b_ * pow(c_, 2)}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p.Differentiate(var_x_), p_x);
    ...
    const GenericPolynomial<MonomialBasisElement> p_a{
            {{MonomialBasisElement(var_x_, 2), 4 * a_ * b_}, {MonomialBasisElement(), 7 * c_}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p.Differentiate(var_a_), p_a);

    // d/db p = 2a²x² + 3c²x
    const GenericPolynomial<MonomialBasisElement> p_b{
            {{MonomialBasisElement(var_x_, 2), 2 * pow(a_, 2)}, {MonomialBasisElement(var_x_), 3 * pow(c_, 2)}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p.Differentiate(var_b_), p_b);

    // d/dc p = 6bcx + 7a
    const GenericPolynomial<MonomialBasisElement> p_c{
            {{MonomialBasisElement(var_x_), 6 * b_ * c_}, {MonomialBasisElement(), 7 * a_}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p.Differentiate(var_c_), p_c);
}
...
TEST_F(SymbolicGenericPolynomialTest, DifferentiateForChebyshevBasis1) {
    ...
    // dp/dx = 2a²bT₃(y)
    const GenericPolynomial<ChebyshevBasisElement> p_x{{{ChebyshevBasisElement(var_y_, 3), 2 * pow(a_, 2) * b_}}};
    EXPECT_PRED2(GenericPolyEqual<ChebyshevBasisElement>, p.Differentiate(var_x_), p_x);
    ...
    const GenericPolynomial<ChebyshevBasisElement> p_y(
            {{ChebyshevBasisElement(var_x_), 6 * pow(a_, 2) * b_},
             {ChebyshevBasisElement({{var_x_, 1}, {var_y_, 2}}), 12 * pow(a_, 2) * b_},
             {ChebyshevBasisElement(var_y_), 12 * a_ * c_}});
    EXPECT_PRED2(GenericPolyEqual<ChebyshevBasisElement>, p.Differentiate(var_y_), p_y);
    ...
    EXPECT_PRED2(GenericPolyEqual<ChebyshevBasisElement>, p.Differentiate(var_a_), p_a);
}
...
TEST_F(SymbolicGenericPolynomialTest, DifferentiateForChebyshevBasis2) {
    ...
    const GenericPolynomial<ChebyshevBasisElement> p({{ChebyshevBasisElement(var_x_), a_},
                                                      {ChebyshevBasisElement(var_x_, 2), a_},
                                                      {ChebyshevBasisElement(var_x_, 3), pow(a_, 2)}});

    // dp/dx = (a+3a²)T₀(x) + 4aT₁(x) + 6a²T₂(x)
    const GenericPolynomial<ChebyshevBasisElement> p_x({{ChebyshevBasisElement(nullptr), a_ + 3 * pow(a_, 2)},
                                                        {ChebyshevBasisElement(var_x_), 4 * a_},
                                                        {ChebyshevBasisElement(var_x_, 2), 6 * pow(a_, 2)}});
    EXPECT_PRED2(GenericPolyEqual<ChebyshevBasisElement>, p.Differentiate(var_x_), p_x);

    // dp/da =T₁(x)+T₂(x)+2aT₃(x)
    const GenericPolynomial<ChebyshevBasisElement> p_a({{ChebyshevBasisElement(var_x_), 1},
...
TEST_F(SymbolicGenericPolynomialTest, Jacobian) {
    // p = ax²y + (3a+b)xz²
    const GenericPolynomial<MonomialBasisElement> p{{{MonomialBasisElement({{var_x_, 2}, {var_y_, 1}}), a_},
    ...
    static_assert(decltype(J_xy)::RowsAtCompileTime == 1 && decltype(J_xy)::ColsAtCompileTime == 2,
                  "The size of J_xy should be 1 x 2.");
    // dp/dx = 2axy + (3a+b)z²
    const GenericPolynomial<MonomialBasisElement> p_x({{MonomialBasisElement({{var_x_, 1}, {var_y_, 1}}), 2 * a_},
                                                       {MonomialBasisElement(var_z_, 2), 3 * a_ + b_}});
    // dp/dy = ax²
    const GenericPolynomial<MonomialBasisElement> p_y({{MonomialBasisElement(var_x_, 2), a_}});
    ...
    // dp/da = x²y + 3xz²
    const GenericPolynomial<MonomialBasisElement> p_a({{MonomialBasisElement({{var_x_, 2}, {var_y_, 1}}), 1},
                                                       {MonomialBasisElement({{var_x_, 1}, {var_z_, 2}}), 3}});
    // dp/db = xz²
    const GenericPolynomial<MonomialBasisElement> p_b(MonomialBasisElement({{var_x_, 1}, {var_z_, 2}}));
...
TEST_F(SymbolicGenericPolynomialTest, ConstructNonPolynomialCoefficients) {
    ...
    vector<pair<Expression, GenericPolynomial<MonomialBasisElement>::MapType>> testcases;

    // sin(a)x = sin(a) * x
    testcases.emplace_back(sin(a_) * x_,
                           GenericPolynomial<MonomialBasisElement>::MapType{{{MonomialBasisElement{x_}, sin(a_)}}});

    // cos(a)(x + 1)² = cos(a) * x² + 2cos(a) * x + cos(a) * 1
    testcases.emplace_back(cos(a_) * pow(x_ + 1, 2), GenericPolynomial<MonomialBasisElement>::MapType{
    ...
    testcases.emplace_back(
            ...
            GenericPolynomial<MonomialBasisElement>::MapType{{{MonomialBasisElement{{{var_x_, 2}}}, log(a_) / sqrt(b_)},
                                                              {MonomialBasisElement{x_}, 2 * log(a_) / sqrt(b_)},
                                                              {MonomialBasisElement{}, log(a_) / sqrt(b_)}}});

    //   (tan(a)x + 1)²
    // = (tan(a))² * x² + 2tan(a) * x + 1
    testcases.emplace_back(pow(tan(a_) * x_ + 1, 2), GenericPolynomial<MonomialBasisElement>::MapType{
    ...
    testcases.emplace_back(
            ...
            GenericPolynomial<MonomialBasisElement>::MapType{{{MonomialBasisElement{x_}, abs(b_ + 1) - atan(c_)},
    ...
    testcases.emplace_back(
            ...
            GenericPolynomial<MonomialBasisElement>::MapType{{{MonomialBasisElement{{{var_x_, 1}, {var_y_, 1}}},  // xy
                                                               abs(b_) * atan2(a_, c_)}}});
    ...
    testcases.emplace_back(
            (sinh(a_) * x_ + cosh(b_) * y_ + tanh(c_) * z_) / (5 * min(a_, b_) * max(b_, c_)),
            GenericPolynomial<MonomialBasisElement>::MapType{{{
    ...
    // = + 2 * ceil(a) * floor(b) * xy
    // = + pow(floor(a), 2) * y²
    testcases.emplace_back(pow(ceil(a_) * x_ + floor(b_) * y_, 2),
                           GenericPolynomial<MonomialBasisElement>::MapType{
                                   {{MonomialBasisElement{{{var_x_, 2}}}, ceil(a_) * ceil(a_)},
                                    {MonomialBasisElement{{{var_x_, 1}, {var_y_, 1}}}, 2 * ceil(a_) * floor(b_)},
    ...
    testcases.emplace_back(uf1 * x_ * uf2 * x_, GenericPolynomial<MonomialBasisElement>::MapType{
                                                        {{MonomialBasisElement{{{var_x_, 2}}}, uf1 * uf2}}});

    //   (x + y)² = x² + 2xy + y²
    testcases.emplace_back(pow(x_ + y_, 2), GenericPolynomial<MonomialBasisElement>::MapType{{
    ...
    // pow(pow(x, 2.5), 2) = x⁵
    testcases.emplace_back(pow(pow(x_, 2.5), 2), GenericPolynomial<MonomialBasisElement>::MapType{
                                                         {{MonomialBasisElement{{{var_x_, 5}}}, 1}}});

    // pow(pow(x * y, 2.5), 2) = (xy)⁵
    testcases.emplace_back(pow(pow(x_ * y_, 2.5), 2), GenericPolynomial<MonomialBasisElement>::MapType{
...
TEST_F(SymbolicGenericPolynomialTest, NegativeTestConstruction1) {
    ...
    DRAKE_EXPECT_NO_THROW(GenericPolynomial<MonomialBasisElement>(e1, indeterminates_));

    // sin(x) * x is a not polynomial.
    const Expression e2{sin(x_) * x_};
    EXPECT_THROW(GenericPolynomial<MonomialBasisElement>(e2, indeterminates_), runtime_error);
}

TEST_F(SymbolicGenericPolynomialTest, NegativeTestConstruction2) {
    // aˣ x is not a polynomial.
    const Expression e{pow(a_, x_)};
    EXPECT_THROW(GenericPolynomial<MonomialBasisElement>(e, indeterminates_), runtime_error);
}
...
TEST_F(SymbolicGenericPolynomialTest, Evaluate) {
    ...
    const double expected1{1.0 * -1.0 * -1.0 * -2.0 + 2.0 * -1.0 * -2.0 + 3.0 * -3.0};
    ...
    const double expected2{4.0 * -7.0 * -7.0 * -5.0 + 1.0 * -7.0 * -5.0 + 2.0 * -2.0};
...
TEST_F(SymbolicGenericPolynomialTest, PartialEvaluate1) {
    ...
    const GenericPolynomial<MonomialBasisElement> p1{
            {{MonomialBasisElement(var_x_, 2), a_}, {MonomialBasisElement(var_x_), b_}, {MonomialBasisElement(), c_}}};
    const GenericPolynomial<MonomialBasisElement> p2{{{MonomialBasisElement(), a_ * 3.0 * 3.0 + b_ * 3.0 + c_}}};
    const Environment env{{{var_x_, 3.0}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.EvaluatePartial(env), p2);
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.EvaluatePartial(var_x_, 3.0), p2);
}

TEST_F(SymbolicGenericPolynomialTest, PartialEvaluate2) {
    // p1 = a*xy² - a*xy + c
    // p2 = p1[y ↦ 2.0] = (4a - 2a)*x + c = 2ax + c
    const GenericPolynomial<MonomialBasisElement> p1{{{MonomialBasisElement({{var_x_, 1}, {var_y_, 2}}), a_},
    ...
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.EvaluatePartial(env), p2);
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.EvaluatePartial(var_y_, 2.0), p2);
}
...
TEST_F(SymbolicGenericPolynomialTest, PartialEvaluate3) {
    ...
    const GenericPolynomial<MonomialBasisElement> p1{
            {{MonomialBasisElement(var_x_, 2), a_}, {MonomialBasisElement(var_x_), b_}, {MonomialBasisElement(), c_}}};
    const GenericPolynomial<MonomialBasisElement> p2{{{MonomialBasisElement(), 18 + 3 * b_ + c_}}};
...
TEST_F(SymbolicGenericPolynomialTest, PartialEvaluate4) {
    ...
    const GenericPolynomial<MonomialBasisElement> p{{{MonomialBasisElement(var_x_, 2), (a_ + c_) / (b_ + c_)},
...
TEST_F(SymbolicGenericPolynomialTest, EqualTo) {
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, GenericPolynomial<MonomialBasisElement>(),
    ...
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>,
                 ...
                 GenericPolynomial<MonomialBasisElement>({{MonomialBasisElement(var_x_), 1}}));

    EXPECT_FALSE(GenericPolynomial<MonomialBasisElement>(MonomialBasisElement(var_x_))
                         .EqualTo(GenericPolynomial<MonomialBasisElement>(MonomialBasisElement(var_y_))));
    EXPECT_FALSE(GenericPolynomial<MonomialBasisElement>(MonomialBasisElement(var_x_))
                         .EqualTo(GenericPolynomial<MonomialBasisElement>({{MonomialBasisElement(var_y_), a_}})));

    EXPECT_FALSE(GenericPolynomial<MonomialBasisElement>(
                         {{MonomialBasisElement(var_x_), 1}, {MonomialBasisElement(var_x_, 2), 2}})
                         .EqualTo(GenericPolynomial<MonomialBasisElement>({{MonomialBasisElement(var_x_), 1}})));

    EXPECT_FALSE(GenericPolynomial<MonomialBasisElement>(
                         {{MonomialBasisElement(var_x_), 2}, {MonomialBasisElement(var_x_, 2), 2}})
...
TEST_F(SymbolicGenericPolynomialTest, AddProduct1) {
    ...
    GenericPolynomial<MonomialBasisElement> p(
            {{MonomialBasisElement(var_x_, 2), a_}, {MonomialBasisElement({{var_x_, 1}, {var_y_, 1}}), b_}});
    const GenericPolynomial<MonomialBasisElement> sum = p.AddProduct(c_, MonomialBasisElement(var_z_, 2));
...
TEST_F(SymbolicGenericPolynomialTest, AddProduct2) {
    ...
    GenericPolynomial<MonomialBasisElement> p(
            {{MonomialBasisElement(var_x_, 2), a_}, {MonomialBasisElement({{var_x_, 1}, {var_y_, 1}}), b_}});
    const GenericPolynomial<MonomialBasisElement> sum = p.AddProduct(c_, MonomialBasisElement(var_x_, 2));
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, sum, p);
    const GenericPolynomial<MonomialBasisElement> sum_expected(
            {{MonomialBasisElement(var_x_, 2), a_ + c_}, {MonomialBasisElement({{var_x_, 1}, {var_y_, 1}}), b_}});
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, sum, sum_expected);
    EXPECT_EQ(p.decision_variables(), Variables({var_a_, var_b_, var_c_}));
...
TEST_F(SymbolicGenericPolynomialTest, CoefficientsAlmostEqual) {
    ...
    EXPECT_TRUE(p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{x_ * x_}, 1e-6));
    EXPECT_TRUE(p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{(1 + 1e-7) * x_ * x_}, 1e-6));
    EXPECT_FALSE(p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{2 * x_ * x_}, 1e-6));
    // Another polynomial with an additional small constant term.
    EXPECT_TRUE(p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{x_ * x_ + 1e-7}, 1e-6));
    EXPECT_FALSE(p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{x_ * x_ + 2e-6}, 1e-6));
    EXPECT_TRUE(GenericPolynomial<MonomialBasisElement>{x_ * x_ + 1e-7}.CoefficientsAlmostEqual(p1, 1e-6));
    EXPECT_FALSE(GenericPolynomial<MonomialBasisElement>{x_ * x_ + 2e-6}.CoefficientsAlmostEqual(p1, 1e-6));
    // Another polynomial with small difference on coefficients.
    EXPECT_TRUE(
            p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{(1. - 1e-7) * x_ * x_ + 1e-7}, 1e-6));
    EXPECT_FALSE(
            p1.CoefficientsAlmostEqual(GenericPolynomial<MonomialBasisElement>{(1. + 2e-6) * x_ * x_ + 1e-7}, 1e-6));

    // Another polynomial with decision variables in the coefficient.
    const symbolic::GenericPolynomial<MonomialBasisElement> p2(a_ * x_ * x_, {indeterminates_});
    EXPECT_TRUE(p2.CoefficientsAlmostEqual(
            GenericPolynomial<MonomialBasisElement>{(a_ + 1e-7) * x_ * x_, {indeterminates_}}, 1e-6));
    EXPECT_FALSE(p2.CoefficientsAlmostEqual(
            GenericPolynomial<MonomialBasisElement>{(a_ + 1e-7) * x_ * x_, {indeterminates_}}, 1e-8));
}

TEST_F(SymbolicGenericPolynomialTest, RemoveTermsWithSmallCoefficients) {
    // Single term.
    GenericPolynomial<MonomialBasisElement> p1{{{MonomialBasisElement(var_x_, 2), 1e-5}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.RemoveTermsWithSmallCoefficients(1E-4),
                 GenericPolynomial<MonomialBasisElement>(0));
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.RemoveTermsWithSmallCoefficients(1E-5),
                 GenericPolynomial<MonomialBasisElement>(0));
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p1.RemoveTermsWithSmallCoefficients(1E-6), p1);

    // Multiple terms.
    const GenericPolynomial<MonomialBasisElement> p2{{{MonomialBasisElement(var_x_, 2), 2},
    ...
    const GenericPolynomial<MonomialBasisElement> p2_cleaned{
            {{MonomialBasisElement(var_x_, 2), 2}, {MonomialBasisElement({{var_x_, 1}, {var_y_, 1}}), 3}}};
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p2.RemoveTermsWithSmallCoefficients(1E-4), p2_cleaned);
    ...
    EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>,
                 GenericPolynomial<MonomialBasisElement>(p3_map).RemoveTermsWithSmallCoefficients(1E-3),
...
TEST_F(SymbolicGenericPolynomialTest, EqualToAfterExpansion) {
    ...
    const GenericPolynomial<MonomialBasisElement> p1({{MonomialBasisElement(var_x_, 2), (a_ + b_) * (a_ + c_)}});
    const GenericPolynomial<MonomialBasisElement> p2(
            {{MonomialBasisElement(var_x_, 2), pow(var_a_, 2) + a_ * b_ + a_ * c_ + b_ * c_}});
    // No expansion
...
TEST_F(SymbolicGenericPolynomialTest, SetIndeterminates) {
...

    {
        ...
        EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p,
    ...
    {
        // {x, a, b, c} -> {x}
        GenericPolynomial<MonomialBasisElement> p{e, {var_x_, var_a_, var_b_, var_c_}};
        const Variables new_indeterminates{var_x_};
        p.SetIndeterminates(new_indeterminates);
        EXPECT_PRED2(GenericPolyEqual<MonomialBasisElement>, p,
                     GenericPolynomial<MonomialBasisElement>(e, new_indeterminates));
