...
void DoAddProduct(const Expression& coeff,
                  const BasisElement& basis_element,
...
public:
    MonomialBasisMapType Decompose(const Expression& e, const Variables& indeterminates) const {
        // Note that it calls `Expression::Expand()` here.
        return Visit(e.Expand(), indeterminates);
    }

private:
    MonomialBasisMapType Visit(const Expression& e, const Variables& indeterminates) const {
        return VisitExpression<MonomialBasisMapType>(this, e, indeterminates);
    }

    MonomialBasisMapType VisitVariable(const Expression& e, const Variables& indeterminates) const {
    ...
    MonomialBasisMapType VisitConstant(const Expression& e, const Variables&) const {
    ...
    MonomialBasisMapType VisitAddition(const Expression& e, const Variables& indeterminates) const {
        // e = c₀ + ∑ᵢ (cᵢ * eᵢ)
    ...
    MonomialBasisMapType VisitMultiplication(const Expression& e, const Variables& indeterminates) const {
        // e = c * ∏ᵢ pow(baseᵢ, exponentᵢ).
        const double c = get_constant_in_multiplication(e);
        Expression coeff{c};
        MonomialBasisElement m{};
        for (const auto& [base_i, exponent_i] : get_base_to_exponent_map_in_multiplication(e)) {
    ...
    pair<MonomialBasisElement, Expression> VisitPow(const Expression& base,
        ...
        if (intersect(base.GetVariables(), indeterminates).empty()) {
            ...
            if (!is_variable(base)) {
                ostringstream oss;
                oss << "Base " << base << " is not an indeterminate, " << indeterminates;
                throw runtime_error(oss.str());
            }
    ...
    MonomialBasisMapType VisitPow(const Expression& e, const Variables& indeterminates) const {
        const Expression& base{get_first_argument(e)};
        const Expression& exponent{get_second_argument(e)};
        const pair<MonomialBasisElement, Expression> result{VisitPow(base, exponent, indeterminates)};
        return MonomialBasisMapType{{{result.first, result.second}}};
    }

    MonomialBasisMapType VisitDivision(const Expression& e, const Variables& indeterminates) const {
        // e = e₁ / e₂
    ...
    // indeterminate `x`.
    MonomialBasisMapType VisitNonPolynomialTerm(const Expression& e, const Variables& indeterminates) const {
        // vars(e) ∩ indeterminates = ∅.
    ...
    MonomialBasisMapType VisitAbs(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitLog(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitExp(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitSqrt(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitSin(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitCos(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitTan(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitAsin(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitAcos(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitAtan(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitAtan2(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitSinh(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitCosh(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitTanh(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitMin(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitMax(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitCeil(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitFloor(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitIfThenElse(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }
    MonomialBasisMapType VisitUninterpretedFunction(const Expression& e, const Variables& indeterminates) const {
        return VisitNonPolynomialTerm(e, indeterminates);
    }

    // Makes VisitExpression a friend of this class so that it can use private
    // methods.
    friend MonomialBasisMapType drake::symbolic::VisitExpression<MonomialBasisMapType>(
            const DecomposePolynomialVisitor*, const Expression&, const Variables&);
};

template <typename BasisElement>
Variables GetIndeterminates(const typename GenericPolynomial<BasisElement>::MapType& m) {
    Variables vars;
...
template <typename BasisElement>
Variables GetDecisionVariables(const typename GenericPolynomial<BasisElement>::MapType& m) {
    Variables vars;
    for (const pair<const BasisElement, Expression>& p : m) {
...
GenericPolynomial<BasisElement>::GenericPolynomial(MapType init)
    : basis_element_to_coefficient_map_{std::move(init)},
      indeterminates_{GetIndeterminates<BasisElement>(basis_element_to_coefficient_map_)},
      decision_variables_{GetDecisionVariables<BasisElement>(basis_element_to_coefficient_map_)} {
...
GenericPolynomial<BasisElement>::GenericPolynomial(const BasisElement& m)
    : basis_element_to_coefficient_map_{{m, 1}}, indeterminates_{m.GetVariables()}, decision_variables_{} {
...
template <typename BasisElement>
GenericPolynomial<BasisElement>::GenericPolynomial(const Expression& e, Variables indeterminates)
    ...
    if constexpr (std::is_same_v<BasisElement, MonomialBasisElement>) {
        ...
        for (const auto& [monomial, coeff] : monomial_to_coefficient_map) {
            const std::map<BasisElement, double> monomial_to_basis_element = monomial.template ToBasis<BasisElement>();
            for (const auto& [basis_element, coeff2] : monomial_to_basis_element) {
                DoAddProduct(coeff2 * coeff, basis_element, &basis_element_to_coefficient_map_);
            }
        }
    }
    decision_variables_ = GetDecisionVariables<BasisElement>(basis_element_to_coefficient_map_);
...
template <typename BasisElement>
void GenericPolynomial<BasisElement>::SetIndeterminates(const Variables& new_indeterminates) {
...
int GenericPolynomial<BasisElement>::Degree(const Variable& v) const {
    int degree{0};
    for (const pair<const BasisElement, Expression>& p : basis_element_to_coefficient_map_) {
...
Expression GenericPolynomial<BasisElement>::ToExpression() const {
    // Returns ∑ᵢ (cᵢ * mᵢ).
    return accumulate(basis_element_to_coefficient_map_.begin(), basis_element_to_coefficient_map_.end(),
                      Expression{0.0},
                      [](const Expression& init, const pair<const BasisElement, Expression>& p) {
...
template <typename BasisElement>
GenericPolynomial<BasisElement> GenericPolynomial<BasisElement>::Differentiate(const Variable& x) const {
    if (this->indeterminates_.include(x)) {
        // x is an indeterminate.
        GenericPolynomial<BasisElement>::MapType map;
        for (const auto& [basis_element, coeff] : this->basis_element_to_coefficient_map_) {
            // Take the derivative of basis_element m as dm/dx = sum_{key}
            // basis_element_gradient[key] * key.
            const std::map<BasisElement, double> basis_element_gradient = basis_element.Differentiate(x);
...
double GenericPolynomial<BasisElement>::Evaluate(const Environment& env) const {
    return accumulate(basis_element_to_coefficient_map_.begin(), basis_element_to_coefficient_map_.end(), 0.0,
...
template <typename BasisElement>
GenericPolynomial<BasisElement> GenericPolynomial<BasisElement>::EvaluatePartial(const Environment& env) const {
    ...
    for (const auto& [basis_element, coeff] : basis_element_to_coefficient_map_) {
        ...
        const pair<double, BasisElement> partial_eval_result{basis_element.EvaluatePartial(env)};
        const Expression new_coeff{coeff_partial_evaluated * partial_eval_result.first};
...
template <typename BasisElement>
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator+=(const GenericPolynomial<BasisElement>& p) {
    for (const auto& [basis_element, coeff] : p.basis_element_to_coefficient_map()) {
...
template <typename BasisElement>
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator+=(const BasisElement& m) {
    // No need to call CheckInvariant since it's called inside of AddProduct.
    return AddProduct(1.0, m);
}

template <typename BasisElement>
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator+=(const double c) {
    // No need to call CheckInvariant since it's called inside of AddProduct.
    return AddProduct(c, BasisElement{});
}

template <typename BasisElement>
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator+=(const Variable& v) {
...
template <typename BasisElement>
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator-=(double c) {
    // No need to call CheckInvariant() since it's called inside of Add.
    return AddProduct(-c, BasisElement{});
}
...
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator*=(const GenericPolynomial<BasisElement>& p) {
    ...
    MapType new_map{};
    for (const auto& [basis_element1, coeff1] : basis_element_to_coefficient_map()) {
        for (const auto& [basis_element2, coeff2] : p.basis_element_to_coefficient_map()) {
            // basis_element_products stores the product of two basis elements as a
            // weighted sum of new basis elements.
            const std::map<BasisElement, double> basis_element_products{basis_element1 * basis_element2};
...
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::operator*=(const BasisElement& m) {
    MapType new_map;
    for (const auto& [basis_element, coeff] : basis_element_to_coefficient_map_) {
        const std::map<BasisElement, double> basis_element_product{basis_element * m};
        for (const auto& [new_basis_element, coeff_product] : basis_element_product) {
...
template <typename BasisElement>
GenericPolynomial<BasisElement>& GenericPolynomial<BasisElement>::AddProduct(const Expression& coeff,
...
template <typename BasisElement>
GenericPolynomial<BasisElement> GenericPolynomial<BasisElement>::RemoveTermsWithSmallCoefficients(
        double coefficient_tol) const {
    DRAKE_DEMAND(coefficient_tol >= 0);
    MapType cleaned_polynomial{};
    for (const auto& [basis_element, coeff] : basis_element_to_coefficient_map_) {
        if (is_constant(coeff) && std::abs(get_constant_value(coeff)) <= coefficient_tol) {
            // The coefficients are small.
            continue;
        } else {
            cleaned_polynomial.emplace_hint(cleaned_polynomial.end(), basis_element, coeff);
        }
    }
...
template <typename BasisElement>
GenericPolynomial<BasisElement> GenericPolynomial<BasisElement>::EvaluatePartial(const Variable& var,
...
bool GenericPolynomialEqual(const GenericPolynomial<BasisElement>& p1,
                            ...
                            bool do_expansion) {
    const typename GenericPolynomial<BasisElement>::MapType& map1{p1.basis_element_to_coefficient_map()};
    const typename GenericPolynomial<BasisElement>::MapType& map2{p2.basis_element_to_coefficient_map()};
...
template <typename BasisElement>
bool GenericPolynomial<BasisElement>::EqualTo(const GenericPolynomial<BasisElement>& p) const {
    return GenericPolynomialEqual<BasisElement>(*this, p, false);
}

template <typename BasisElement>
bool GenericPolynomial<BasisElement>::EqualToAfterExpansion(const GenericPolynomial<BasisElement>& p) const {
    return GenericPolynomialEqual<BasisElement>(*this, p, true);
}

template <typename BasisElement>
bool GenericPolynomial<BasisElement>::CoefficientsAlmostEqual(const GenericPolynomial<BasisElement>& p,
                                                              double tol) const {
    ...
    while (it1 != this->basis_element_to_coefficient_map_.end() &&
        ...
        if (it1->first == it2->first) {
            ...
            if (is_constant(coeff_diff) && std::abs(get_constant_value(coeff_diff)) <= tol) {
                it1++;
                it2++;
                continue;
            } else {
            ...
            if (is_constant(it1->second) && std::abs(get_constant_value(it1->second)) < tol) {
                it1++;
                continue;
            } else {
                return false;
            ...
            if (is_constant(it2->second) && std::abs(get_constant_value(it2->second)) < tol) {
                it2++;
                continue;
            } else {
                return false;
...
template <typename BasisElement>
Formula GenericPolynomial<BasisElement>::operator==(const GenericPolynomial<BasisElement>& p) const {
    ...
    for (const pair<const BasisElement, Expression>& item : diff.basis_element_to_coefficient_map_) {
        const Expression& coeff{item.second};
