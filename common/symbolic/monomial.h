...
public:
    ...
    friend void hash_append(HashAlgorithm& hasher, const Monomial& item) noexcept {
...
template <>
struct NumTraits<drake::symbolic::Monomial> : GenericNumTraits<drake::symbolic::Monomial> {
...
template <>
EIGEN_DEVICE_FUNC inline drake::symbolic::Expression cast(const drake::symbolic::Monomial& m) {
