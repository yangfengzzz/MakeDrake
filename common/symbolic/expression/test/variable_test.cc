...
TEST_F(VariableTest, MakeVectorVariable) {
    const VectorX<Variable> vec1{MakeVectorVariable(2, "x", Variable::Type::CONTINUOUS)};
    const Vector2<Variable> vec2{MakeVectorVariable<2>("x", Variable::Type::CONTINUOUS)};
...
TEST_F(VariableTest, MakeMatrixVariable) {
    const MatrixX<Variable> m1{MakeMatrixVariable(1, 2, "x", Variable::Type::CONTINUOUS)};
