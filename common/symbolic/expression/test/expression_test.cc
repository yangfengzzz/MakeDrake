...
#include "common/test_utilities/is_memcpy_movable.h"
...
protected:
    ...
    const vector<Expression> collection_{e_constant_, e_var_,  e_add_,  e_neg_,   e_mul_,  e_div_,  e_log_,
...
TEST_F(SymbolicExpressionTest, Dummy) { EXPECT_TRUE(is_nan(dummy_value<Expression>::get())); }
...
TEST_F(SymbolicExpressionTest, IsConstant1) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_constant(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsOne) { EXPECT_TRUE(is_one(Expression::One())); }
...
TEST_F(SymbolicExpressionTest, IsVariable) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_variable(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsAddition) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_addition(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsMultiplication) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_multiplication(e); })};
    EXPECT_EQ(cnt, 2);
}
...
TEST_F(SymbolicExpressionTest, IsDivision) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_division(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsLog) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_log(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsAbs) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_abs(e); })};
    EXPECT_EQ(cnt, 1);
}
TEST_F(SymbolicExpressionTest, IsExp) {
    EXPECT_TRUE(is_exp(e_exp_));
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_exp(e); })};
    EXPECT_EQ(cnt, 1);
}
TEST_F(SymbolicExpressionTest, IsSqrt) {
    EXPECT_TRUE(is_sqrt(e_sqrt_));
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_sqrt(e); })};
    EXPECT_EQ(cnt, 1);
}
TEST_F(SymbolicExpressionTest, IsPow) {
    EXPECT_TRUE(is_pow(e_pow_));
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_pow(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsSin) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_sin(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsCos) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_cos(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsTan) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_tan(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsAsin) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_asin(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsAcos) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_acos(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsAtan) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_atan(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsAtan2) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_atan2(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsSinh) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_sinh(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsCosh) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_cosh(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsTanh) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_tanh(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsMin) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_min(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsMax) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_max(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsCeil) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_ceil(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsFloor) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_floor(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsIfThenElse) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_if_then_else(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsNaN) {
    ...
    const vector<Expression>::difference_type cnt{
            count_if(collection_.begin(), collection_.end(), [](const Expression& e) { return is_nan(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, IsUninterpretedFunction) {
    ...
    const vector<Expression>::difference_type cnt{count_if(
            collection_.begin(), collection_.end(), [](const Expression& e) { return is_uninterpreted_function(e); })};
    EXPECT_EQ(cnt, 1);
}
...
TEST_F(SymbolicExpressionTest, GetConstantFactorInMultiplication) {
    ...
    EXPECT_PRED2(ExprEqual, get_constant_in_multiplication(2 * x_ * y_ * y_), 2.0);
    EXPECT_PRED2(ExprEqual, get_constant_in_multiplication(-3 * x_ * y_ * y_), -3.0);
}

TEST_F(SymbolicExpressionTest, GetProductsInMultiplication) {
    const Expression e{2 * x_ * y_ * y_ * pow(z_, y_)};
    const map<Expression, Expression> products{get_base_to_exponent_map_in_multiplication(e)};
...
TEST_F(SymbolicExpressionTest, IsPolynomial) {
    const vector<pair<Expression, bool>> test_vec{
            {e_constant_, true}, {e_var_, true},   {e_neg_, true},    {e_add_, true},   {e_mul_, true},
            {e_div_, false},     {e_log_, false},  {e_abs_, false},   {e_exp_, false},  {e_sqrt_, false},
            {e_pow_, false},     {e_sin_, false},  {e_cos_, false},   {e_tan_, false},  {e_asin_, false},
            {e_acos_, false},    {e_atan_, false}, {e_atan2_, false}, {e_sinh_, false}, {e_cosh_, false},
            {e_tanh_, false},    {e_min_, false},  {e_max_, false},   {e_ceil_, false}, {e_floor_, false},
            {e_ite_, false},     {e_nan_, false},  {e_uf_, false}};
...
TEST_F(SymbolicExpressionTest, LessKind) {
    CheckOrdering({e_constant_, e_var_, e_add_, e_neg_,  e_mul_,   e_div_,  e_log_,  e_abs_,   e_exp_,  e_sqrt_,
                   e_pow_,      e_sin_, e_cos_, e_tan_,  e_asin_,  e_acos_, e_atan_, e_atan2_, e_sinh_, e_cosh_,
                   e_tanh_,     e_min_, e_max_, e_ceil_, e_floor_, e_ite_,  e_nan_,  e_uf_});
}
...
TEST_F(SymbolicExpressionTest, Evaluate) { EXPECT_THROW(x_plus_y_.Evaluate(), std::runtime_error); }
...
TEST_F(SymbolicExpressionTest, HashUnary) {
    ...
    // distinct.
    unordered_set<size_t> hash_set;
    const vector<Expression> exprs{e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14};
    for (auto const& e : exprs) {
        hash_set.insert(get_std_hash(e));
    }
    EXPECT_EQ(hash_set.size(), exprs.size());
...
TEST_F(SymbolicExpressionTest, UnaryMinus) {
    ...
    EXPECT_PRED2(ExprEqual, -(x_plus_y_ + x_plus_z_ + pi_), -x_plus_y_ + (-x_plus_z_) + (-pi_));
...
TEST_F(SymbolicExpressionTest, Add5) { EXPECT_EQ((inf_ + (-inf_)).to_string(), e_nan_.to_string()); }
...
TEST_F(SymbolicExpressionTest, Mul4) {
    ...
    EXPECT_PRED2(ExprEqual, (x_ * y_ * y_ * x_) * (x_ * y_ * x_ * y_), pow(x_, 4) * pow(y_, 4));
...
TEST_F(SymbolicExpressionTest, Mul6) {
    ...
    EXPECT_EQ((2 * x_ * x_ * y_ * y_ * y_).to_string(), "(2 * pow(x, 2) * pow(y, 3))");
    EXPECT_EQ((-3 * x_ * x_ * y_ * y_ * y_).to_string(), "(-3 * pow(x, 2) * pow(y, 3))");
}
...
TEST_F(SymbolicExpressionTest, Div5) { EXPECT_EQ((inf_ / inf_).to_string(), e_nan_.to_string()); }
...
TEST_F(SymbolicExpressionTest, Log) {
    ...
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::log(2 * 3.2 * M_PI) + std::log(2) + std::log(3.2));
...
TEST_F(SymbolicExpressionTest, Abs) {
    ...
    const Environment env{{var_x_, -2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::fabs(-2 * 3.2 * M_PI) + std::fabs(-2.0) + std::fabs(3.2));
...
TEST_F(SymbolicExpressionTest, Exp) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::exp(2 * 3.2 * M_PI) + std::exp(2.0) + std::exp(3.2));
...
TEST_F(SymbolicExpressionTest, Sqrt2) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::sqrt(2 * 3.2 * M_PI) + std::sqrt(2.0) + std::sqrt(3.2));
    EXPECT_EQ((sqrt(x_)).to_string(), "sqrt(x)");
}

TEST_F(SymbolicExpressionTest, Pow1) {
    // pow(x, 0.0) => 1.0
    EXPECT_PRED2(ExprEqual, pow(x_plus_y_, Expression::Zero()), Expression::One());
    // pow(x, 1.0) => x
...
TEST_F(SymbolicExpressionTest, Pow2) {
    ...
    EXPECT_DOUBLE_EQ(e2.Evaluate(env), std::pow(2, 2) * std::pow(3.2, 2) * std::pow(2, 3.2));
}
...
TEST_F(SymbolicExpressionTest, Sin) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::sin(2 * 3.2 * M_PI) + std::sin(2) + std::sin(3.2));
...
TEST_F(SymbolicExpressionTest, Cos) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::cos(2 * 3.2 * M_PI) + std::cos(2) + std::cos(3.2));
...
TEST_F(SymbolicExpressionTest, Tan) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::tan(2 * 3.2 * M_PI) + std::tan(2) + std::tan(3.2));
...
TEST_F(SymbolicExpressionTest, Asin) {
    ...
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::asin(0.2 * 0.3 * M_PI) + std::asin(0.2) + std::asin(0.3));
...
TEST_F(SymbolicExpressionTest, Acos) {
    ...
    const Environment env{{var_x_, 0.2}, {var_y_, 0.3}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::acos(0.2 * 0.3 * M_PI) + std::acos(0.2) + std::acos(0.3));
...
TEST_F(SymbolicExpressionTest, Atan) {
    ...
    const Environment env{{var_x_, 0.2}, {var_y_, 0.3}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::atan(0.2 * 0.3 * M_PI) + std::atan(0.2) + std::atan(0.3));
...
TEST_F(SymbolicExpressionTest, Atan2) {
    ...
    EXPECT_DOUBLE_EQ(atan2(neg_pi_, neg_pi_).Evaluate(), std::atan2(-M_PI, -M_PI));

    const Expression e{atan2(x_ * y_ * pi_, sin(x_) + sin(y_))};
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::atan2(2 * 3.2 * M_PI, std::sin(2) + std::sin(3.2)));
...
TEST_F(SymbolicExpressionTest, Sinh) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::sinh(2 * 3.2 * M_PI) + std::sinh(2) + std::sinh(3.2));
...
TEST_F(SymbolicExpressionTest, Cosh) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::cosh(2 * 3.2 * M_PI) + std::cosh(2) + std::cosh(3.2));
...
TEST_F(SymbolicExpressionTest, Tanh) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::tanh(2 * 3.2 * M_PI) + std::tanh(2) + std::tanh(3.2));
...
TEST_F(SymbolicExpressionTest, Min2) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::min(2 * 3.2 * M_PI, std::sin(2) + std::sin(3.2)));
...
TEST_F(SymbolicExpressionTest, Max2) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::max(2 * 3.2 * M_PI, std::sin(2) + std::sin(3.2)));
...
TEST_F(SymbolicExpressionTest, Ceil) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::ceil(2 * 3.2 * M_PI) + std::ceil(2) + std::ceil(3.2));
...
TEST_F(SymbolicExpressionTest, Floor) {
    ...
    const Environment env{{var_x_, 2}, {var_y_, 3.2}};
    EXPECT_DOUBLE_EQ(e.Evaluate(env), std::floor(2 * 3.2 * M_PI) + std::floor(2) + std::floor(3.2));
...
TEST_F(SymbolicExpressionTest, UninterpretedFunction_GetVariables_GetName_GetArguments) {
    ...
    const vector<Expression>& the_arguments{get_uninterpreted_function_arguments(uf3)};
...
TEST_F(SymbolicExpressionTest, GetVariables) {
    ...
    const Variables vars2{
            (x_ * x_ * z_ - y_ * abs(x_) * log(x_ + y_) + cosh(x_) + cosh(y_) + atan2(x_, y_)).GetVariables()};
...
TEST_F(SymbolicExpressionTest, ToString) {
    ...
    EXPECT_EQ(e3.to_string(), "(3.1415926535897931 * x * pow(y, 2.7182818284590451))");
    EXPECT_EQ(e4.to_string(), "(2.7182818284590451 + x + 3.1415926535897931 * y)");
...
TEST_F(SymbolicExpressionTest, ExtractDoubleTest) {
    ...
    EXPECT_TRUE(CompareMatrices(ExtractDoubleOrThrow(v1), Eigen::Vector2d{12.0, 13.0}));
...
TEST_F(SymbolicExpressionTest, GetDistinctVariables) {
    EXPECT_EQ(GetDistinctVariables(Vector1<Expression>{x_plus_y_}), Variables({var_x_, var_y_}));
    EXPECT_EQ(GetDistinctVariables(Vector1<Expression>{x_plus_z_}), Variables({var_x_, var_z_}));
    EXPECT_EQ(GetDistinctVariables(Vector2<Expression>{x_plus_y_, x_plus_z_}), Variables({var_x_, var_y_, var_z_}));
    EXPECT_EQ(GetDistinctVariables(RowVector2<Expression>{x_plus_z_, e_cos_}), Variables({var_x_, var_z_}));
}
...
TEST_F(SymbolicExpressionTest, TaylorExpand1) {
    ...
    const Expression expected{
            std::exp(-5) * (1 - 2 * (x - 1) - 4 * (y - 2) + pow(x - 1, 2) + 8 * (x - 1) * (y - 2) + 7 * pow(y - 2, 2))};
...
TEST_F(SymbolicExpressionTest, TaylorExpand2) {
    ...
    const Expression expanded{TaylorExpand(e, env, 2)};
    // Obtained from Matlab.
    const Expression expected{8 * sin(5) * (x - 1) * (y - 2) - (cos(5) - 2 * sin(5)) * (x - 1) * (x - 1) -
                              (cos(5) - 8 * sin(5)) * (y - 2) * (y - 2) - 2 * cos(5) * (x - 1) - 4 * cos(5) * (y - 2) -
                              sin(5)};
    // The difference should be close to zero. We sample a few points around (1,
    // 2) and test.
    const vector<Environment> test_envs{{{{var_x_, 0}, {var_y_, 0}}},
...
TEST_F(SymbolicExpressionTest, TaylorExpand3) {
    ...
    // Obtained from Matlab.
    const Expression expected{cos(3) - sin(5) + (sin(3) * pow(z - 3, 3)) / 6 - (cos(5) - 2 * sin(5)) * pow(x - 1, 2) -
                              (cos(5) - 8 * sin(5)) * pow(y - 2, 2) + pow(x - 1, 3) * ((4 * cos(5)) / 3 + 2 * sin(5)) +
                              pow(y - 2, 3) * ((32 * cos(5)) / 3 + 4 * sin(5)) - 2 * cos(5) * (x - 1) -
                              4 * cos(5) * (y - 2) - sin(3) * (z - 3) - (cos(3) * pow(z - 3, 2)) / 2 +
                              pow(x - 1, 2) * (y - 2) * (8 * cos(5) + 4 * sin(5)) +
                              (x - 1) * pow(y - 2, 2) * (16 * cos(5) + 2 * sin(5)) + 8 * sin(5) * (x - 1) * (y - 2)};

    // The difference should be close to zero. We sample a few points around (1,
    // 2) and test.
    const vector<Environment> test_envs{
            {{{var_x_, 0}, {var_y_, 0}, {var_z_, 0}}}, {{{var_x_, 0}, {var_y_, 0}, {var_z_, 3}}},
            {{{var_x_, 0}, {var_y_, 3}, {var_z_, 0}}}, {{{var_x_, 3}, {var_y_, 0}, {var_z_, 0}}},
            {{{var_x_, 0}, {var_y_, 3}, {var_z_, 3}}}, {{{var_x_, 3}, {var_y_, 3}, {var_z_, 0}}},
            {{{var_x_, 3}, {var_y_, 0}, {var_z_, 3}}}, {{{var_x_, 3}, {var_y_, 3}, {var_z_, 3}}}};
    for (const auto& test_env : test_envs) {
        EXPECT_NEAR((expanded - expected).Evaluate(test_env), 0.0, 1e-10);
    }
}
...
TEST_F(SymbolicExpressionTest, TaylorExpandPartialEnv1) {
    ...
    const Expression expected{cos(y) + sin(1) + (x - 1) * cos(1) - 0.5 * (x - 1) * (x - 1) * sin(1)};
...
TEST_F(SymbolicExpressionTest, TaylorExpandPartialEnv2) {
    ...
    const Expression expected{a * sin(2) + a * (x - 2) * cos(2) - 0.5 * (x - 2) * (x - 2) * a * sin(2) -
...
TEST_F(SymbolicExpressionTest, UniformRealDistribution) {
    ...
    { EXPECT_THROW(uniform_real_distribution<Expression>(1.0, 0.0), runtime_error); }
    ...
    // x + (y - x) * v where v is a random uniform variable.
    {
        ...
        const auto it = find_if(vars.begin(), vars.end(),
                                [](const Variable& v) { return v.get_type() == Variable::Type::RANDOM_UNIFORM; });
    ...
    // operator== and operator!=.
    {
        ...
        EXPECT_TRUE(uniform_real_distribution<Expression>(0.0, 1.0) != uniform_real_distribution<Expression>(0.0, 1.0));
    }
...
TEST_F(SymbolicExpressionTest, NormalDistribution) {
    using std::normal_distribution;
    {
        ...
        EXPECT_EQ(double_distribution.mean(), symbolic_distribution.mean().Evaluate());
        EXPECT_EQ(double_distribution.stddev(), symbolic_distribution.stddev().Evaluate());
    }
    {
        // Constructor with a single argument.
    ...
    // x + y * v where v is a random Gaussian variable.
    {
        ...
        ASSERT_EQ(vars.size(), 3);
        const auto it = find_if(vars.begin(), vars.end(),
                                [](const Variable& v) { return v.get_type() == Variable::Type::RANDOM_GAUSSIAN; });
        ASSERT_TRUE(it != vars.end());
        const Variable& v{*it};
    ...
    // min() and max().
    EXPECT_EQ(symbolic_distribution.min().Evaluate(), -std::numeric_limits<double>::infinity());
    EXPECT_EQ(symbolic_distribution.max().Evaluate(), +std::numeric_limits<double>::infinity());
    ...
    // operator== and operator!=.
    {
        ...
        // Note that the two newly created distributions have the same parameters,
        // however, they are considered NOT identical.
        EXPECT_FALSE(normal_distribution<Expression>(0.0, 1.0) == normal_distribution<Expression>(0.0, 1.0));
        EXPECT_TRUE(normal_distribution<Expression>(0.0, 1.0) != normal_distribution<Expression>(0.0, 1.0));
    }
...
TEST_F(SymbolicExpressionTest, ExponentialDistribution) {
    using std::exponential_distribution;
    {
        ...
        EXPECT_EQ(double_distribution.lambda(), symbolic_distribution.lambda().Evaluate());
    }
    ...
    // v / y where v is a random exponential variable.
    {
        ...
        const auto it = find_if(vars.begin(), vars.end(),
                                [](const Variable& v) { return v.get_type() == Variable::Type::RANDOM_EXPONENTIAL; });
        ASSERT_TRUE(it != vars.end());
        const Variable& v{*it};
    ...
    // operator== and operator!=.
    {
        ...
        // Note that the two newly created distributions have the same parameters,
        // however, they are considered NOT identical.
        EXPECT_FALSE(exponential_distribution<Expression>(2.0) == exponential_distribution<Expression>(2.0));
        EXPECT_TRUE(exponential_distribution<Expression>(2.0) != exponential_distribution<Expression>(2.0));
    }
...
// +---------------------+                             +--------------------+
::testing::AssertionResult CheckExpressionWithRandomVariables(const Expression& e,
                                                              const Environment& env,
                                                              RandomGenerator* const random_generator) {
    RandomGenerator random_generator_copy(*random_generator);
    const double v1{e.GetVariables().empty() ? e.Evaluate(random_generator) : e.Evaluate(env, random_generator)};

    const Environment env_extended{PopulateRandomVariables(env, e.GetVariables(), &random_generator_copy)};
    const double v2{e.Evaluate(env_extended, nullptr)};

    if (v1 == v2) {
        return ::testing::AssertionSuccess();
    } else {
        return ::testing::AssertionFailure() << "Different evaluation results:\n"
                                             << "e = " << e << "\n"
                                             << "env = " << env << "\n"
