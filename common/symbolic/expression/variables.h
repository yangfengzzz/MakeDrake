...
public:
    ...
    typedef typename std::set<Variable>::const_reverse_iterator const_reverse_iterator;
    ...
    friend void hash_append(HashAlgorithm& hasher, const Variables& item) noexcept {
