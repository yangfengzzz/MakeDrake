...
public:
     ...
     */
    [[nodiscard]] Formula Substitute(const Variable& var, const Expression& e) const;
    ...
    friend std::shared_ptr<const RelationalFormulaCell> to_relational(const Formula& f);
    ...
    friend std::shared_ptr<const FormulaGeq> to_greater_than_or_equal_to(const Formula& f);
    friend std::shared_ptr<const FormulaLt> to_less_than(const Formula& f);
    friend std::shared_ptr<const FormulaLeq> to_less_than_or_equal_to(const Formula& f);
    ...
    friend std::shared_ptr<const FormulaPositiveSemidefinite> to_positive_semidefinite(const Formula& f);
...
typename std::enable_if_t<std::is_same_v<typename Eigen::internal::traits<Derived>::XprKind, Eigen::MatrixXpr> &&
...
template <typename DerivedA,
          ...
          typename = std::enable_if_t<
                  std::is_same_v<typename Eigen::internal::traits<DerivedA>::XprKind, Eigen::ArrayXpr> &&
                  std::is_same_v<typename Eigen::internal::traits<DerivedB>::XprKind, Eigen::ArrayXpr> &&
                  std::is_same_v<decltype(typename DerivedA::Scalar() == typename DerivedB::Scalar()), Formula>>>
struct RelationalOpTraits {
    static constexpr auto Dynamic = Eigen::Dynamic;
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wold-style-cast"
    static constexpr int Rows =
            EIGEN_SIZE_MIN_PREFER_FIXED((DerivedA::RowsAtCompileTime), (DerivedB::RowsAtCompileTime));
    static constexpr int Cols =
            EIGEN_SIZE_MIN_PREFER_FIXED((DerivedA::ColsAtCompileTime), (DerivedB::ColsAtCompileTime));
...
typename std::enable_if_t<std::is_same_v<typename Eigen::internal::traits<Derived>::XprKind, Eigen::ArrayXpr> &&
...
template <typename DerivedA, typename DerivedB>
typename std::enable_if_t<
        std::is_same_v<typename Eigen::internal::traits<DerivedA>::XprKind, Eigen::MatrixXpr> &&
                std::is_same_v<typename Eigen::internal::traits<DerivedB>::XprKind, Eigen::MatrixXpr> &&
                std::is_same_v<decltype(typename DerivedA::Scalar() == typename DerivedB::Scalar()), Formula>,
        Formula>
...
operator>=(const DerivedA& m1, const DerivedB& m2) {
    EIGEN_STATIC_ASSERT_SAME_MATRIX_SIZE(DerivedA, DerivedB);
    DRAKE_DEMAND(m1.rows() == m2.rows() && m1.cols() == m2.cols());
    return m1.binaryExpr(m2, std::greater_equal<void>()).redux(internal::logic_and);
}
...
struct less<drake::symbolic::Formula> {
    bool operator()(const drake::symbolic::Formula& lhs, const drake::symbolic::Formula& rhs) const {
        return lhs.Less(rhs);
    }
};
...
template <>
struct NumTraits<drake::symbolic::Formula> : GenericNumTraits<drake::symbolic::Formula> {
...
template <>
struct scalar_cmp_op<drake::symbolic::Expression, drake::symbolic::Expression, cmp_EQ>
    : binary_op_base<drake::symbolic::Expression, drake::symbolic::Expression> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Expression& a,
...
/// Provides specialization for scalar_cmp_op to handle the case "Expr < Expr".
template <>
struct scalar_cmp_op<drake::symbolic::Expression, drake::symbolic::Expression, cmp_LT>
    : binary_op_base<drake::symbolic::Expression, drake::symbolic::Expression> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Expression& a,
                                                                 const drake::symbolic::Expression& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Expr <= Expr".
template <>
struct scalar_cmp_op<drake::symbolic::Expression, drake::symbolic::Expression, cmp_LE>
    : binary_op_base<drake::symbolic::Expression, drake::symbolic::Expression> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Expression& a,
                                                                 const drake::symbolic::Expression& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Expr > Expr".
template <>
struct scalar_cmp_op<drake::symbolic::Expression, drake::symbolic::Expression, cmp_GT>
    : binary_op_base<drake::symbolic::Expression, drake::symbolic::Expression> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Expression& a,
                                                                 const drake::symbolic::Expression& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Expr >= Expr".
template <>
struct scalar_cmp_op<drake::symbolic::Expression, drake::symbolic::Expression, cmp_GE>
    : binary_op_base<drake::symbolic::Expression, drake::symbolic::Expression> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Expression& a,
                                                                 const drake::symbolic::Expression& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Expr != Expr".
template <>
struct scalar_cmp_op<drake::symbolic::Expression, drake::symbolic::Expression, cmp_NEQ>
    : binary_op_base<drake::symbolic::Expression, drake::symbolic::Expression> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Expression& a,
                                                                 const drake::symbolic::Expression& b) const {
...
struct minmax_compare<drake::symbolic::Expression, NaNPropagation, true> {
    ...
    static EIGEN_DEVICE_FUNC inline bool compare(Scalar a, Scalar b) { return static_cast<bool>(a < b); }
};
...
template <>
struct scalar_cmp_op<drake::symbolic::Variable, drake::symbolic::Variable, cmp_EQ>
    : binary_op_base<drake::symbolic::Variable, drake::symbolic::Variable> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Variable& a,
...
/// Provides specialization for scalar_cmp_op to handle the case "Var < Var".
template <>
struct scalar_cmp_op<drake::symbolic::Variable, drake::symbolic::Variable, cmp_LT>
    : binary_op_base<drake::symbolic::Variable, drake::symbolic::Variable> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Variable& a,
                                                                 const drake::symbolic::Variable& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Var <= Var".
template <>
struct scalar_cmp_op<drake::symbolic::Variable, drake::symbolic::Variable, cmp_LE>
    : binary_op_base<drake::symbolic::Variable, drake::symbolic::Variable> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Variable& a,
                                                                 const drake::symbolic::Variable& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Var > Var".
template <>
struct scalar_cmp_op<drake::symbolic::Variable, drake::symbolic::Variable, cmp_GT>
    : binary_op_base<drake::symbolic::Variable, drake::symbolic::Variable> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Variable& a,
                                                                 const drake::symbolic::Variable& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Var >= Var".
template <>
struct scalar_cmp_op<drake::symbolic::Variable, drake::symbolic::Variable, cmp_GE>
    : binary_op_base<drake::symbolic::Variable, drake::symbolic::Variable> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Variable& a,
                                                                 const drake::symbolic::Variable& b) const {
...
/// Provides specialization for scalar_cmp_op to handle the case "Var != Var".
template <>
struct scalar_cmp_op<drake::symbolic::Variable, drake::symbolic::Variable, cmp_NEQ>
    : binary_op_base<drake::symbolic::Variable, drake::symbolic::Variable> {
    typedef drake::symbolic::Formula result_type;
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE result_type operator()(const drake::symbolic::Variable& a,
                                                                 const drake::symbolic::Variable& b) const {
...
template <>
EIGEN_STRONG_INLINE bool equal_strict(const drake::symbolic::Expression& x, const drake::symbolic::Expression& y) {
    if (is_zero(x)) {
        return is_zero(y);
    }
    if (is_zero(y)) {
...
template <>
EIGEN_STRONG_INLINE bool not_equal_strict(const drake::symbolic::Expression& x, const drake::symbolic::Expression& y) {
