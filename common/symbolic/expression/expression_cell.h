...
public:
    ...
    [[nodiscard]] const std::map<Expression, double>& get_expr_to_coeff_map() const { return expr_to_coeff_map_; }

private:
    std::ostream& DisplayTerm(std::ostream& os, bool print_plus, double coeff, const Expression& term) const;
...
private:
    std::ostream& DisplayTerm(std::ostream& os,
                              bool print_mul,
