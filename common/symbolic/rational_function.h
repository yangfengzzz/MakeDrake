...
typename std::enable_if_t<std::is_base_of_v<Eigen::MatrixBase<MatrixL>, MatrixL> &&
                          ...
                          Eigen::Matrix<RationalFunction, MatrixL::RowsAtCompileTime, MatrixR::ColsAtCompileTime>>
operator*(const MatrixL& lhs, const MatrixR& rhs) {
    return lhs.template cast<RationalFunction>() * rhs.template cast<RationalFunction>();
}
#endif
}  // namespace symbolic
}  // namespace drake
...
template <>
struct NumTraits<drake::symbolic::RationalFunction> : GenericNumTraits<drake::symbolic::RationalFunction> {
...
// where op ∈ {+, -, *, conj_product}.
DRAKE_SYMBOLIC_SCALAR_SUM_DIFF_PRODUCT_CONJ_PRODUCT_TRAITS(drake::symbolic::RationalFunction,
...
namespace numext {
template <>
bool equal_strict(const drake::symbolic::RationalFunction& x, const drake::symbolic::RationalFunction& y);
template <>
EIGEN_STRONG_INLINE bool not_equal_strict(const drake::symbolic::RationalFunction& x,
