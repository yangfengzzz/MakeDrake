...
void PolynomialEvaluatePartial(benchmark::State& state) {  // NOLINT
    ...
    const auto monomial_basis = internal::ComputeMonomialBasis<Eigen::Dynamic>(x_set, 2);
...
BENCHMARK(MatrixInnerProduct)->ArgsProduct({{10, 50, 100, 200}, {false, true}})->Unit(benchmark::kSecond);
BENCHMARK(GemmDV)->ArgsProduct({{10, 50, 100, 200}})->Unit(benchmark::kMillisecond);
BENCHMARK(GemmDE)->ArgsProduct({{10, 50, 100, 200}})->Unit(benchmark::kMillisecond);
BENCHMARK(GemmVE)->ArgsProduct({{10, 50, 100, 200}})->Unit(benchmark::kMillisecond);
BENCHMARK(GemmEE)->ArgsProduct({{10, 50, 100, 200}})->Unit(benchmark::kMillisecond);
}  // namespace
}  // namespace symbolic
}  // namespace drake
