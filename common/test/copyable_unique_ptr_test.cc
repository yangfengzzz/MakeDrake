...
struct Base {
    explicit Base(int v, Origin org = Origin::CONSTRUCT) : origin(org), value(v) {}
    virtual ~Base() {}
...
GTEST_TEST(CopyableUniquePtrTest, FriendsWithBenefits) {
    copyable_unique_ptr<FriendsWithBenefitsCopy> fwb(new FriendsWithBenefitsCopy(10));
    EXPECT_EQ(fwb->value(), 10);

    copyable_unique_ptr<FriendsWithBenefitsCopy> fwb2(fwb);
    EXPECT_EQ(fwb2->value(), 10);

    copyable_unique_ptr<FriendsWithBenefitsClone> fwbc(new FriendsWithBenefitsClone(20));
...
struct FullyCopyable : Base {
    explicit FullyCopyable(int v, Origin org = Origin::CONSTRUCT) : Base(v, org) {}
    FullyCopyable(const FullyCopyable& b) : Base(b) {}
    unique_ptr<FullyCopyable> Clone() const { return make_unique<FullyCopyable>(value, Origin::CLONE); }
};
...
struct CloneOnly : Base {
    ...
    unique_ptr<CloneOnly> Clone() const { return unique_ptr<CloneOnly>(DoClone()); }

protected:
    CloneOnly(const CloneOnly& other) : Base(other.value) {}
    [[nodiscard]] virtual CloneOnly* DoClone() const { return new CloneOnly(value, Origin::CLONE); }
};
...
struct CloneOnlyChildWithClone : CloneOnly {
    explicit CloneOnlyChildWithClone(int v, Origin org = Origin::CONSTRUCT) : CloneOnly(v, org) {}
    CloneOnlyChildWithClone(const CloneOnlyChildWithClone&) = delete;
    unique_ptr<CloneOnlyChildWithClone> Clone() const { return unique_ptr<CloneOnlyChildWithClone>(DoClone()); }
...
struct CloneOnlyChildWithCopyVClone : CloneOnly {
    explicit CloneOnlyChildWithCopyVClone(int v, Origin org = Origin::CONSTRUCT) : CloneOnly(v, org) {}
...
struct CloneOnlyChildWithCopy : CloneOnly {
    explicit CloneOnlyChildWithCopy(int v, Origin org = Origin::CONSTRUCT) : CloneOnly(v, org) {}
...
struct CloneOnlyChildUncopyable : CloneOnly {
    explicit CloneOnlyChildUncopyable(int v, Origin org = Origin::CONSTRUCT) : CloneOnly(v, org) {}
...
struct DestructorTracker : public CloneOnly {
    explicit DestructorTracker(int v, Origin org = Origin::CONSTRUCT) : CloneOnly(v, org) {}
    virtual ~DestructorTracker() { dtor_called = true; }
    DestructorTracker(const DestructorTracker&) = delete;
    unique_ptr<DestructorTracker> Clone() const { return make_unique<DestructorTracker>(value, Origin::CLONE); }
...
GTEST_TEST(CopyableUniquePtrTest, PointerAccessConstSemantics) {
    ...
    EXPECT_TRUE((std::is_same_v<const CloneOnly*, decltype(ptr_to_const.get_mutable())>));
