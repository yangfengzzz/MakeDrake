...
DRAKE_DEPRECATED("2038-01-19", "Don't use this function; use NewMethod() instead.")
...
GTEST_TEST(DrakeDeprecatedTest, WarnOnceTest) {
    static const drake::internal::WarnDeprecated warn_once("2038-01-19",
                                                           "The method OldCalc() has been renamed to NewCalc().");
}
...
GTEST_TEST(DrakeDeprecatedTest, WarnThrowsTest) {
    ...
    DRAKE_EXPECT_THROWS_MESSAGE(drake::internal::WarnDeprecated("2038-01-19", "Hello"),
