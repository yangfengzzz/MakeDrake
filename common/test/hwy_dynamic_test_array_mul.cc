...
void ArrayMulImpl(const Eigen::ArrayXd& x0, const Eigen::ArrayXd& x1, Eigen::ArrayXd* y) {
...
void ArrayMul(const Eigen::ArrayXd& x0, const Eigen::ArrayXd& x1, Eigen::ArrayXd* y1) {
