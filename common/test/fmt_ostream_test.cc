...
public:
    friend std::ostream& operator<<(std::ostream& os, const UnportedStreamable&) { return os << "US"; }
};
}  // namespace sample
namespace fmt {
template <>
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& os, const ThirdPartyStreamable&) { return os << "TPS"; }
};
}  // namespace sample
