...
#define DRAKE_UNREACHABLE() ::drake::internal::Abort("Unreachable code was reached?!", __func__, __FILE__, __LINE__)
...
#define DRAKE_DEMAND(condition)                                                                         \
    do {                                                                                                \
        ...
        if (!Trait::Evaluate(condition)) {                                                              \
            ::drake::internal::AssertionFailed(#condition, __func__, __FILE__, __LINE__);               \
        }                                                                                               \
    } while (0)
