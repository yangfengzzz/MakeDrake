...
template <typename T>
VectorLog<T>::VectorLog(int input_size) : sample_times_(kDefaultCapacity), data_(input_size, kDefaultCapacity) {
...
DRAKE_DEFINE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::systems::VectorLog);
