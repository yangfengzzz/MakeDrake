...
public:
    ...
    described above. */
    explicit TransferFunction(MatrixX<symbolic::RationalFunction> H, double time_step = 0.0);

    /** Convenience overload for single-input, single-output (SISO) systems. */
    explicit TransferFunction(symbolic::RationalFunction H, double time_step = 0.0);
    ...
    static symbolic::RationalFunction s() { return symbolic::RationalFunction(symbolic::Monomial(s_var())); }
    ...
    */
    ...
    static symbolic::RationalFunction z() { return symbolic::RationalFunction(symbolic::Monomial(z_var())); }
