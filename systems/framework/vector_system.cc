...
template <typename T>
EventStatus VectorSystem<T>::CalcDiscreteUpdate(const Context<T>& context, DiscreteValues<T>* discrete_state) const {
...
DRAKE_DEFINE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::systems::VectorSystem);
