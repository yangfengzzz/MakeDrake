...
public:
    void VisitSystem(const System<double>& system) final { visited_systems_.push_back(&system); }
    void VisitDiagram(const Diagram<double>& diagram) final { visited_diagrams_.push_back(&diagram); }
