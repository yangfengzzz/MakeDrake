...
public:
    ...
    template <class MyUntemplatizedSystem>
    MyUntemplatizedSystem& GetMutableDowncastSubsystemByName(std::string_view name) {
        static_assert(std::is_same_v<typename MyUntemplatizedSystem::Scalar, T>,
                      "Scalar type of untemplatized System doesn't match the "
                      "DiagramBuilder's.");
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::systems::DiagramBuilder);
