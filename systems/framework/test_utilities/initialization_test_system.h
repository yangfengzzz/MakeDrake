...
public:
    InitializationTestSystem() {
        ...
        PublishEvent<double> pub_event(
                ...
                [this](const System<double>&, const Context<double>&, const PublishEvent<double>& event) {
        ...
        DiscreteUpdateEvent<double> discrete_update_event(
                TriggerType::kInitialization,
                [this](const System<double>&, const Context<double>&, const DiscreteUpdateEvent<double>& event,
        ...
        UnrestrictedUpdateEvent<double> unrestricted_update_event(
                TriggerType::kInitialization,
                [this](const System<double>&, const Context<double>&, const UnrestrictedUpdateEvent<double>& event,
                       State<double>* state) {
                    EXPECT_EQ(event.get_trigger_type(), TriggerType::kInitialization);
