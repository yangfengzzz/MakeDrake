#include "systems/framework/port_base.h"
...
std::string PortBase::GetFullDescription() const {
    return fmt::format("{}Port[{}] ({}) of System {} ({})", kind_string_, index_, name_,
...
void PortBase::ThrowValidateContextMismatch() const {
    throw std::logic_error(fmt::format("{}Port: The Context given as an argument was not created for this {}",
...
void PortBase::ThrowBadCast(const std::string& value_typename, const std::string& eval_typename) const {
    throw std::logic_error(
            fmt::format("{}Port::Eval(): wrong value type {} specified; "
                        "actual type was {} for {}.",
