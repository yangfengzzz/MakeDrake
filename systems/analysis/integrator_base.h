...
public:
    ...
    /**
     ...
     @param context A pointer to a writeable context (nullptr is ok, but a
                    ...
                    the context.
     */
    explicit IntegratorBase(const System<T>& system, Context<T>* context = nullptr)
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class drake::systems::IntegratorBase);
