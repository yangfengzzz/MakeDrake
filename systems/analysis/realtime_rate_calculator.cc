...
std::optional<double> RealtimeRateCalculator::UpdateAndRecalculate(double current_sim_time) {
...
void RealtimeRateCalculator::InjectMockTimer(std::unique_ptr<Timer> mock_timer) {
