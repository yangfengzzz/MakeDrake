...
TYPED_TEST_P(GenericIntegratorTest, DenseOutput) {
    ...
    for (int i = 1; i <= n_steps; ++i) {
        ...
        // Check solution.
        EXPECT_TRUE(CompareMatrices(this->integrator_->get_dense_output()->value(this->context_->get_time()),
    ...
    std::unique_ptr<trajectories::PiecewisePolynomial<double>> dense_output = this->integrator_->StopDenseIntegration();
