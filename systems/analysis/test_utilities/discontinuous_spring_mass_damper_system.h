...
template <class T>
class DiscontinuousSpringMassDamperSystem final : public SpringMassDamperSystem<T> {
public:
    ...
    DiscontinuousSpringMassDamperSystem(double spring_constant_N_per_m,
        ...
        : SpringMassDamperSystem<T>(SystemTypeTag<DiscontinuousSpringMassDamperSystem>{},
    ...
    template <typename U>
    explicit DiscontinuousSpringMassDamperSystem(const DiscontinuousSpringMassDamperSystem<U>& other)
        : DiscontinuousSpringMassDamperSystem(other.get_spring_constant(),
