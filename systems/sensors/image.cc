...
void ConvertDepthPixelwise(const InputImage& input, OutputImage* output, Func func) {
...
void ConvertDepth32FTo16U(const ImageDepth32F& input, ImageDepth16U* output) {
    ...
    ConvertDepthPixelwise(input, output, [](const ImageDepth32F::T pixel) -> ImageDepth16U::T {
...
void ConvertDepth16UTo32F(const ImageDepth16U& input, ImageDepth32F* output) {
    DRAKE_THROW_UNLESS(output != nullptr);
    ConvertDepthPixelwise(input, output, [](const ImageDepth16U::T pixel) -> ImageDepth32F::T {
