...
public:
    ...
    /// MoveAssignable
    //@{
    BeamModelParams(const BeamModelParams& other) : drake::systems::BasicVector<T>(other.values()) {}
    BeamModelParams(BeamModelParams&& other) noexcept : drake::systems::BasicVector<T>(std::move(other.values())) {}
    ...
    typename std::enable_if_t<std::is_same_v<U, symbolic::Expression>> SetToNamedVariables() {
    ...
    [[nodiscard]] BeamModelParams<T>* DoClone() const final { return new BeamModelParams; }
