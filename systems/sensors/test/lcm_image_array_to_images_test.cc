...
GTEST_TEST(LcmImageArrayToImagesTest, JpegTest) {
    ...
    LoadImageData(FindResourceOrThrow("drake/systems/sensors/test/jpeg_test.jpg"), &jpeg_image);
...
GTEST_TEST(LcmImageArrayToImagesTest, PngTest) {
    ...
    LoadImageData(FindResourceOrThrow("drake/systems/sensors/test/png_color_test.png"), &png_image);
    ...
    LoadImageData(FindResourceOrThrow("drake/systems/sensors/test/png_gray16_test.png"), &png_image);
