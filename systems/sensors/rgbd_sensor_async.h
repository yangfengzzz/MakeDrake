...
public:
    ...
    RgbdSensorAsync(const geometry::SceneGraph<double>* scene_graph,
    ...
    const std::optional<geometry::render::ColorRenderCamera>& color_camera() const { return color_camera_; }

    /** Returns the `depth_camera` passed to the constructor. */
    const std::optional<geometry::render::DepthRenderCamera>& depth_camera() const { return depth_camera_; }
