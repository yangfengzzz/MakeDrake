...
#include "geometry/drake_visualizer_params.h"
#include "geometry/meshcat.h"
#include "geometry/meshcat_visualizer_params.h"
...
#include "systems/lcm/lcm_buses.h"
#include "visualization/visualization_config.h"
...
std::vector<geometry::DrakeVisualizerParams> ConvertVisualizationConfigToDrakeParams(const VisualizationConfig&);

// (This function is declared in the header so that unit tests can call it.)
std::vector<geometry::MeshcatVisualizerParams> ConvertVisualizationConfigToMeshcatParams(const VisualizationConfig&);

// (This function is declared in the header so that unit tests can call it.)
multibody::meshcat::ContactVisualizerParams ConvertVisualizationConfigToMeshcatContactParams(
