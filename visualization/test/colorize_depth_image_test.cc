...
GTEST_TEST(ColorDepthImageTest, Basic32F) {
    ...
    const auto& actual = dut.GetOutputPort("color_image").template Eval<ImageRgba8U>(*context);
...
GTEST_TEST(ColorDepthImageTest, BadlyConnectedInputs) {
    ...
    DRAKE_EXPECT_THROWS_MESSAGE(dut.GetOutputPort("color_image").template Eval<ImageRgba8U>(*context),
