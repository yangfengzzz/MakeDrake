...
public:
    ...
    void set_background_color(const geometry::Rgba& background_color) { background_color_ = background_color; }

    /** Colorizes the `input` into `output`, without using any System port
    conections nor any Context. */
    void Calc(const systems::sensors::ImageLabel16I& input, systems::sensors::ImageRgba8U* output) const;
