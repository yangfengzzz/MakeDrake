...
int lcmt_iiwa_status::_encodeNoHash(void* buf, int offset, int maxlen) const {
    ...
    if (this->num_joints > 0) {
        tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->joint_position_measured[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints > 0) {
        tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->joint_velocity_estimated[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints > 0) {
        tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->joint_position_commanded[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints > 0) {
        tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->joint_torque_measured[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints > 0) {
        tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->joint_torque_commanded[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
...
int lcmt_iiwa_status::_decodeNoHash(const void* buf, int offset, int maxlen) {
    ...
    if (this->num_joints) {
        ...
        tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->joint_position_measured[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints) {
        ...
        tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->joint_velocity_estimated[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints) {
        ...
        tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->joint_position_commanded[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints) {
        ...
        tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->joint_torque_measured[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
    ...
    if (this->num_joints) {
        ...
        tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->joint_torque_commanded[0],
                                     this->num_joints);
        if (tlen < 0)
            return tlen;
        else
