...
int lcmt_hydroelastic_contact_surface_for_viz::_encodeNoHash(void* buf, int offset, int maxlen) const {
    ...
    tlen = __string_encode_array(buf, offset + pos, maxlen - pos, &geometry1_name_cstr, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    ...
    tlen = __string_encode_array(buf, offset + pos, maxlen - pos, &model1_name_cstr, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    ...
    tlen = __string_encode_array(buf, offset + pos, maxlen - pos, &geometry2_name_cstr, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    ...
    tlen = __string_encode_array(buf, offset + pos, maxlen - pos, &model2_name_cstr, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
...
int lcmt_hydroelastic_contact_surface_for_viz::_decodeNoHash(const void* buf, int offset, int maxlen) {
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &__geometry1_name_len__, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    if (__geometry1_name_len__ > maxlen - pos) return -1;
    this->geometry1_name.assign(static_cast<const char*>(buf) + offset + pos, __geometry1_name_len__ - 1);
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &__model1_name_len__, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    if (__model1_name_len__ > maxlen - pos) return -1;
    this->model1_name.assign(static_cast<const char*>(buf) + offset + pos, __model1_name_len__ - 1);
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &__geometry2_name_len__, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    if (__geometry2_name_len__ > maxlen - pos) return -1;
    this->geometry2_name.assign(static_cast<const char*>(buf) + offset + pos, __geometry2_name_len__ - 1);
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &__model2_name_len__, 1);
    if (tlen < 0)
        return tlen;
    else
        pos += tlen;
    if (__model2_name_len__ > maxlen - pos) return -1;
    this->model2_name.assign(static_cast<const char*>(buf) + offset + pos, __model2_name_len__ - 1);
...
uint64_t lcmt_hydroelastic_contact_surface_for_viz::_computeHash(const __lcm_hash_ptr* p) {
    ...
    for (fp = p; fp != NULL; fp = fp->parent)
        if (fp->v == lcmt_hydroelastic_contact_surface_for_viz::getHash) return 0;
