...
std::vector<Eigen::Triplet<Scalar>> SparseMatrixToTriplets(
    ...
    using InnerIterator = typename Eigen::SparseMatrix<Scalar, Options, StorageIndex>::InnerIterator;
...
void SparseMatrixToRowColumnValueVectors(const Derived& matrix,
