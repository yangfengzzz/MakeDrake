...
struct GrayCodesMatrix {
    ...
    typedef typename Eigen::Matrix<int, NumDigits == 0 ? 0 : 1 << NumDigits, NumDigits> type;
};
...
typename GrayCodesMatrix<NumDigits>::type CalculateReflectedGrayCodes(int num_digits = NumDigits) {
