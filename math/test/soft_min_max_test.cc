...
GTEST_TEST(SoftOverMax, TestAutodiff) {
    ...
    EXPECT_NEAR(x_max.
                ...
                3, 0.01);
    EXPECT_TRUE(CompareMatrices(x_max.derivatives(), Eigen::Vector2d(0, -1), 1E-3));
}
...
GTEST_TEST(SoftUnderMax, TestAutoDiff) {
    ...
    EXPECT_NEAR(x_max.
                ...
                2, 1E-2);
    EXPECT_TRUE(CompareMatrices(x_max.derivatives(), Eigen::Vector2d(0, -1), 1E-2));
}
...
GTEST_TEST(SoftOverMin, TestAutoDiff) {
    ...
    EXPECT_NEAR(x_min.
                ...
                0, 1E-2);
    EXPECT_TRUE(CompareMatrices(x_min.derivatives(), Eigen::Vector2d(3, 4), 1E-2));
}
