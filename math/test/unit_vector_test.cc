...
GTEST_TEST(UnitVectorTest, ThrowIfNotUnitVector) {
    ...
    DRAKE_EXPECT_NO_THROW(ThrowIfNotUnitVector(unit_vector, "UnusedFunctionName"));
    ...
    DRAKE_EXPECT_NO_THROW(ThrowIfNotUnitVector(unit_vector_symbolic, "TestSymbolicFunctionName"));
    ...
    DRAKE_EXPECT_THROWS_MESSAGE(ThrowIfNotUnitVector(not_unit_vector, "SomeFunctionName"), expected_message);
