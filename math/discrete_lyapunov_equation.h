...
Eigen::MatrixXd RealDiscreteLyapunovEquation(const Eigen::Ref<const Eigen::MatrixXd>& A,
...
Eigen::Matrix2d Solve2By2RealDiscreteLyapunovEquation(const Eigen::Ref<const Eigen::Matrix2d>& A,
...
Eigen::MatrixXd SolveReducedRealDiscreteLyapunovEquation(const Eigen::Ref<const Eigen::MatrixXd>& A,
                                                         const Eigen::Ref<const Eigen::MatrixXd>& Q);
