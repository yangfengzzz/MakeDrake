...
typename drake::math::Gradient<Eigen::Matrix<typename Derived::Scalar, 3, 3>, 4>::type dquat2rotmat(
        const Eigen::MatrixBase<Derived>& quaternion) {
    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(Eigen::MatrixBase<Derived>, 4);

    typename drake::math::Gradient<Eigen::Matrix<typename Derived::Scalar, 3, 3>, 4>::type ret;
    ...
    ret << w, x, -y, -z, z, y, x, w, -y, z, -w, x, -z, y, x, -w, w, -x, y, -z, x, w, z, y, y, z, w, x, -x, -w, z, y, w,
            -x, -y, z;
    ret *= 2.0;
    ret *= dqtilde;
    return ret;
...
typename drake::math::Gradient<Eigen::Matrix<typename DerivedR::Scalar, 3, 1>, DerivedDR::ColsAtCompileTime>::type
drotmat2rpy(const Eigen::MatrixBase<DerivedR>& R, const Eigen::MatrixBase<DerivedDR>& dR) {
    ...
    typedef typename drake::math::Gradient<Eigen::Matrix<Scalar, 3, 1>, DerivedDR::ColsAtCompileTime>::type ReturnType;
    ...
    drpy.row(1) = (-sqrt_sqterm * dR31_dq + R(2, 0) / sqrt_sqterm * (R(2, 1) * dR32_dq + R(2, 2) * dR33_dq)) /
 ...
 */
template <typename DerivedR, typename DerivedDR>
typename drake::math::Gradient<Eigen::Matrix<typename DerivedR::Scalar, 4, 1>, DerivedDR::ColsAtCompileTime>::type
drotmat2quat(const Eigen::MatrixBase<DerivedR>& R, const Eigen::MatrixBase<DerivedDR>& dR) {
    EIGEN_STATIC_ASSERT_MATRIX_SPECIFIC_SIZE(Eigen::MatrixBase<DerivedR>, 3, 3);
    ...
    typedef typename DerivedR::Scalar Scalar;
    typedef typename drake::math::Gradient<Eigen::Matrix<Scalar, 4, 1>, DerivedDR::ColsAtCompileTime>::type ReturnType;
    typename DerivedDR::Index nq = dR.cols();
