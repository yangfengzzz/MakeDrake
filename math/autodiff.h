...
void InitializeAutoDiff(const Eigen::MatrixBase<Derived>& value,
    ...
    static_assert(static_cast<int>(Derived::RowsAtCompileTime) == static_cast<int>(DerivedAutoDiff::RowsAtCompileTime),
                  "auto diff matrix has wrong number of rows at compile time");
    static_assert(static_cast<int>(Derived::ColsAtCompileTime) == static_cast<int>(DerivedAutoDiff::ColsAtCompileTime),
                  "auto diff matrix has wrong number of columns at compile time");
    static_assert(static_cast<int>(Derived::IsRowMajor) == static_cast<int>(DerivedAutoDiff::IsRowMajor),
...
AutoDiffMatrixType<Derived, nq> InitializeAutoDiff(const Eigen::MatrixBase<Derived>& value,
    ...
    InitializeAutoDiff(value, num_derivatives.value_or(value.size()), deriv_num_start.value_or(0), &auto_diff_matrix);
