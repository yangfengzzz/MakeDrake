...
struct FunctionTraits<std::reference_wrapper<F>> {
    static size_t numInputs(std::reference_wrapper<F> const& f) { return FunctionTraits<F>::numInputs(f.get()); }
    static size_t numOutputs(std::reference_wrapper<F> const& f) { return FunctionTraits<F>::numOutputs(f.get()); }
    template <typename ScalarType>
...
struct FunctionTraits<std::shared_ptr<F>> {
    static size_t numInputs(std::shared_ptr<F> const& f) { return FunctionTraits<F>::numInputs(*f); }
    static size_t numOutputs(std::shared_ptr<F> const& f) { return FunctionTraits<F>::numOutputs(*f); }
    template <typename ScalarType>
...
struct FunctionTraits<std::unique_ptr<F>> {
    static size_t numInputs(std::unique_ptr<F> const& f) { return FunctionTraits<F>::numInputs(*f); }
    static size_t numOutputs(std::unique_ptr<F> const& f) { return FunctionTraits<F>::numOutputs(*f); }
    template <typename ScalarType>
