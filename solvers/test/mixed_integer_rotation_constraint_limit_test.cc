...
class TestMinimumDistance
    : public testing::TestWithParam<std::tuple<MixedIntegerRotationConstraintGenerator::Approach, int>> {
public:
    ...
    TestMinimumDistance()
        ...
        MixedIntegerRotationConstraintGenerator rotation_generator(approach_, num_intervals_per_half_axis_,
...
private:
    void DoSetMinimumDistanceExpected() override {
        ...
        switch (num_intervals_per_half_axis_) {
            ...
            default: {
                throw std::runtime_error("Have not attempted this number of binary variables yet.");
            }
        }
    }
};
