...
INSTANTIATE_TEST_SUITE_P(SCSTest,
                         LinearProgramTest,
...
INSTANTIATE_TEST_SUITE_P(SCSTest, TestEllipsoidsSeparation, ::testing::ValuesIn(GetEllipsoidsSeparationProblems()));
...
INSTANTIATE_TEST_SUITE_P(SCSTest, TestQPasSOCP, ::testing::ValuesIn(GetQPasSOCPProblems()));
...
INSTANTIATE_TEST_SUITE_P(SCSTest, TestFindSpringEquilibrium, ::testing::ValuesIn(GetFindSpringEquilibriumProblems()));
