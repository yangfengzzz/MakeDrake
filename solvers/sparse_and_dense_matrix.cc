...
namespace solvers {
namespace internal {
SparseAndDenseMatrix::SparseAndDenseMatrix(const Eigen::SparseMatrix<double>& sparse) : sparse_(sparse), dense_(0, 0) {}
...
SparseAndDenseMatrix& SparseAndDenseMatrix::operator=(const Eigen::SparseMatrix<double>& sparse) {
    this->sparse_ = sparse;
