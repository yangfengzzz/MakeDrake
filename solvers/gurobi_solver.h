...
public:
    ...
    /// callback function.
    void AddMipNodeCallback(const MipNodeCallbackFunction& callback) { mip_node_callback_ = callback; }
    ...
    typedef std::function<void(const MathematicalProgram&, const SolveStatusInfo& callback_info)>
    ...
    /// callback function.
    void AddMipSolCallback(const MipSolCallbackFunction& callback) { mip_sol_callback_ = callback; }
