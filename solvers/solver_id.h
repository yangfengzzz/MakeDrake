...
public:
    ...
    friend void hash_append(HashAlgorithm& hasher, const SolverId& item) noexcept {
...
struct less<drake::solvers::SolverId> {
    bool operator()(const drake::solvers::SolverId& lhs, const drake::solvers::SolverId& rhs) const {
