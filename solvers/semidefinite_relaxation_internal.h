...
drake::MatrixX<typename Derived::Scalar> ToSymmetricMatrixFromTensorVector(
    ...
    for (int i = 0; i < sym_elt_n; ++i) {
        ...
        ei.insert(i) = 1;
        Eigen::MatrixXd symmetric_matrix_i = math::ToSymmetricMatrixFromLowerTriangularColumns(ei.toDense());
        for (int j = 0; j < sym_elt_m; ++j) {
            Eigen::SparseVector<double> ej(sym_elt_m);
            ej.insert(j) = 1;
            Eigen::MatrixXd symmetric_matrix_j = math::ToSymmetricMatrixFromLowerTriangularColumns(ej.toDense());

            Eigen::SparseMatrix<double> kron =
                    SparseKroneckerProduct(symmetric_matrix_i.sparseView(), symmetric_matrix_j.sparseView());
...
void AddMatrixIsLorentzByPositiveOrthantSeparableConstraint(const Eigen::Ref<const MatrixX<symbolic::Variable>>& X,
...
// Lorentz cone.
void AddMatrixIsLorentzByPositiveOrthantSeparableConstraint(const Eigen::Ref<const MatrixX<symbolic::Expression>>& X,
                                                            MathematicalProgram* prog);
...
void AddMatrixIsPositiveOrthantByLorentzSeparableConstraint(const Eigen::Ref<const MatrixX<symbolic::Variable>>& X,
                                                            MathematicalProgram* prog);
...
// Lorentz cone.
void AddMatrixIsPositiveOrthantByLorentzSeparableConstraint(const Eigen::Ref<const MatrixX<symbolic::Expression>>& X,
                                                            MathematicalProgram* prog);
...
// size X.cols().
void AddMatrixIsLorentzByLorentzSeparableConstraint(const Eigen::Ref<const MatrixX<symbolic::Variable>>& X,
                                                    MathematicalProgram* prog);
...
void AddMatrixIsLorentzByLorentzSeparableConstraint(const Eigen::Ref<const MatrixX<symbolic::Expression>>& X,
                                                    MathematicalProgram* prog);
