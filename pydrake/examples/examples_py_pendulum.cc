...
#include "examples/pendulum/pendulum_geometry.h"
#include "examples/pendulum/pendulum_input.h"
#include "examples/pendulum/pendulum_params.h"
#include "examples/pendulum/pendulum_plant.h"
#include "examples/pendulum/pendulum_state.h"
