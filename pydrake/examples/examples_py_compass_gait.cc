...
#include "examples/compass_gait/compass_gait.h"
#include "examples/compass_gait/compass_gait_continuous_state.h"
#include "examples/compass_gait/compass_gait_geometry.h"
#include "examples/compass_gait/compass_gait_params.h"
