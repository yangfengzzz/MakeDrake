...
public:
    ...
    multibody::contact_solvers::internal::PartialPermutation CalcVertexPermutation() const;
    ...
    multibody::contact_solvers::internal::PartialPermutation CalcVertexPartialPermutation() const;
    ...
    multibody::contact_solvers::internal::PartialPermutation CalcDofPermutation() const;

    /* Returns the partial permutation which is the restriction of the return
     value of `CalcDofPermutation` to the set of dofs that belong to vertices
     participating in contact. */
    multibody::contact_solvers::internal::PartialPermutation CalcDofPartialPermutation() const;
...
public:
    ...
    DeformableContactSurface(GeometryId id_A,
                             GeometryId id_B,
    ...
    const PolygonSurfaceMesh<T>& contact_mesh_W() const { return contact_mesh_W_; }
    ...
    const std::vector<Vector3<T>>& contact_points_W() const { return contact_points_W_; }
    ...
    const std::vector<Vector4<T>>& barycentric_coordinates_A() const { return barycentric_coordinates_A_; }
    ...
    const std::vector<Vector4<int>>& contact_vertex_indexes_A() const { return contact_vertex_indexes_A_; }
...
public:
    ...
    const std::vector<DeformableContactSurface<T>>& contact_surfaces() const { return contact_surfaces_; }
    ...
    const ContactParticipation& contact_participation(GeometryId deformable_id) const {
    ...
    void AddDeformableRigidContactSurface(GeometryId deformable_id,
                                          GeometryId rigid_id,
    ...
    void AddDeformableDeformableContactSurface(GeometryId id0,
                                               GeometryId id1,
    ...
    bool IsRegistered(GeometryId id) const { return contact_participations_.contains(id); }
