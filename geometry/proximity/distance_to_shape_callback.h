...
public:
    ...
    DistancePairGeometry(const GeometryId& id_A,
    ...
    void operator()(const fcl::Sphered& sphere_A, const fcl::Cylinderd& cylinder_B);

    void operator()(const fcl::Sphered& sphere_A, const fcl::Halfspaced& halfspace_B);
...
private:
    ...
    void SphereShapeDistance(const fcl::Sphered& sphere_A, const FclShape& shape_B);
