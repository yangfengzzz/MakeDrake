...
#include "geometry/proximity/polygon_surface_mesh_field.h"
...
public:
     ...
     */
    void SampleVolumeFieldOnSurface(const VolumeMeshFieldLinear<double, double>& volume_field_M,
...
protected:
    ...
    virtual void CalcContactPolygon(const VolumeMeshFieldLinear<double, double>& volume_field_M,
                                    const TriangleSurfaceMesh<double>& surface_N,
                                    const math::RigidTransform<T>& X_MN,
...
private:
     ...
     */
    static bool IsFaceNormalAlongPressureGradient(const VolumeMeshFieldLinear<double, double>& volume_field_M,
                                                  const TriangleSurfaceMesh<double>& surface_N,
