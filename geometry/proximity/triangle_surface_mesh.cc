...
template <typename T>
void TriangleSurfaceMesh<T>::SetAllPositions(const Eigen::Ref<const VectorX<T>>& p_MVs) {
...
DRAKE_DEFINE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_NONSYMBOLIC_SCALARS(class TriangleSurfaceMesh);
