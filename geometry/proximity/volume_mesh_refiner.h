...
public:
    ...
    explicit VolumeMeshRefiner(const VolumeMesh<double>& input_mesh) : input_mesh_(input_mesh) {}
...
private:
    ...
    void CutTetrahedron(int tetrahedron, const std::vector<int>& sub_simplex, int new_vertex);
