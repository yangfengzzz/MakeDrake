...
public:
    ...
    */
    Aabb(const Vector3<double>& p_HoBo, const Vector3<double>& half_width) : center_(p_HoBo), half_width_(half_width) {
...
public:
    ...
    AabbMaker(const MeshType& mesh_M, const std::set<int>& vertices) : mesh_M_(mesh_M), vertices_(vertices) {
