...
public:
    ...
    */
    ...
    static bool HasOverlap(const Obb& bv_H, const Plane<double>& plane_P, const math::RigidTransformd& X_PH);
    ...
    bool Equal(const Obb& other) const {
        ...
        return pose_.IsExactlyEqualTo(other.pose_) && half_width_ == other.half_width_;
    }
...
public:
    ...
    ObbMaker(const MeshType& mesh_M, const std::set<int>& vertices) : mesh_M_(mesh_M), vertices_(vertices) {
