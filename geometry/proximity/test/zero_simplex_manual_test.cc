...
DEFINE_bool(expect_fail, false, "expect to find zero simplices; reverses the success/fail logic");
...
int do_main(int argc, char* argv[]) {
    ...
    drake::log()->info(
            ...
            bad_tets.size(), bad_triangles.size(), bad_edges.size(), mesh.num_elements());
