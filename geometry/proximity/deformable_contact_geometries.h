...
public:
    ...
    const DeformableVolumeMeshWithBvh<double>& deformable_mesh() const { return *deformable_mesh_; }
...
public:
    ...
    explicit RigidGeometry(std::unique_ptr<internal::hydroelastic::RigidMesh> rigid_mesh)
    ...
    void set_pose_in_world(const math::RigidTransform<double>& X_WG) { X_WG_ = X_WG; }
...
std::optional<RigidGeometry> MakeRigidRepresentation(const Shape& shape, const ProximityProperties& props) {
