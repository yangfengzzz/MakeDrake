#include "geometry/meshcat_params.h"
...
bool operator==(const MeshcatParams::PropertyTuple& a, const MeshcatParams::PropertyTuple& b) {
    return std::tie(a.path, a.property, a.value) == std::tie(b.path, b.property, b.value);
}
