...
MeshcatRecording::MeshcatRecording() : animation_{std::make_unique<MeshcatAnimation>()} {}

MeshcatRecording::~MeshcatRecording() = default;

void MeshcatRecording::StartRecording(double frames_per_second, bool set_visualizations_while_recording) {
...
template bool MeshcatRecording::SetProperty(std::string_view, std::string_view, const bool&, std::optional<double>);
template bool MeshcatRecording::SetProperty(std::string_view, std::string_view, const double&, std::optional<double>);
template bool MeshcatRecording::SetProperty(std::string_view,
                                            std::string_view,
...
MeshcatRecording::AnimationDetail MeshcatRecording::CalcDetail(std::optional<double> time_in_recording) const {
