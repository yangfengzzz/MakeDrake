...
public:
    ...
    DeformableMeshWithBvh(DeformableMeshWithBvh&& other)
        : DeformableMeshWithBvh(std::move(other.deformable_mesh_), std::move(other.bvh_)) {}
...
private:
    ...
    DeformableMeshWithBvh(MeshType deformable_mesh_M, Bvh<Aabb, MeshType> bvh_M)
        : deformable_mesh_(std::move(deformable_mesh_M)), bvh_(std::move(bvh_M)), bvh_updater_(&mesh(), &bvh_) {}
