...
MeshcatGraphviz::MeshcatGraphviz(std::optional<std::string_view> path, bool subscribe)
    : path_(ResolvePath(path.value_or(""))), publish_(path.has_value()), subscribe_(subscribe) {}
