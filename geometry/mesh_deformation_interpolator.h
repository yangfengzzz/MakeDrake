...
public:
    ...
    /* Constructs a BarycentricInterpolator. The time complexity of this
     ...
     @throws std::exception if any passively driven point is outside of the
                            control mesh. */
    BarycentricInterpolator(const std::vector<Vector3<double>>& positions_M, const VolumeMesh<double>& control_mesh_M);
...
public:
    ...
    VertexSampler(std::vector<int> sampled_vertices, const VolumeMesh<double>& control_mesh);
...
public:
    ...
    DrivenTriangleMesh(TriangleSurfaceMesh<double> triangle_mesh, const VolumeMesh<double>& control_mesh);
    ...
    DrivenTriangleMesh(std::variant<BarycentricInterpolator, VertexSampler> interpolator,
                       TriangleSurfaceMesh<double> triangle_mesh);

    const TriangleSurfaceMesh<double>& triangle_surface_mesh() const { return triangle_mesh_; }
