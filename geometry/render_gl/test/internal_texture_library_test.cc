...
GTEST_TEST(TextureLibraryTest, TextureKey) {
    const std::string image_link = FindResourceOrThrow("drake/geometry/render/test/meshes/box.png");
...
GTEST_TEST(TextureLibraryTest, SupportedImage) {
    ...
    // Non-existent file.
    EXPECT_FALSE(TextureLibrary::IsSupportedImage((dir / "not_real.png").string()));
