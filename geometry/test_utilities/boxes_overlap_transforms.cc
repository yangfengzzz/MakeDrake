...
RigidTransformd CalcCornerTransform(const Vector3d& a_half,
    ...
    const RotationMatrixd R_AB = RotationMatrixd(AngleAxisd(M_PI / 5, Vector3d::Unit(axis1))) *
...
RigidTransformd CalcEdgeTransform(
        const Vector3d& a_half, const Vector3d& b_half, const int a_axis, const int b_axis, const bool expect_overlap) {
