...
public:
    ...
    [[nodiscard]] bool ContainedIn(const HPolyhedron& other, double tol = 1E-9) const;
    ...
    */
    [[nodiscard]] HPolyhedron SimplifyByIncrementalFaceTranslation(
            double min_volume_ratio = 0.1,
            bool do_affine_transformation = true,
            int max_iterations = 10,
            const Eigen::MatrixXd& points_to_contain = Eigen::MatrixXd(),
            const std::vector<drake::geometry::optimization::HPolyhedron>& intersecting_polytopes =
    ...
    [[nodiscard]] HPolyhedron MaximumVolumeInscribedAffineTransformation(const HPolyhedron& circumbody) const;
    ...
    */
    [[nodiscard]] HPolyhedron Scale(double scale, std::optional<Eigen::VectorXd> center = std::nullopt) const;
    ...
    [[nodiscard]] HPolyhedron PontryaginDifference(const HPolyhedron& other) const;
...
private:
    ...
    [[nodiscard]] HPolyhedron DoIntersectionNoChecks(const HPolyhedron& other) const;

    /* @pre other.ambient_dimension() == this->ambient_dimension() */
    [[nodiscard]] HPolyhedron DoIntersectionWithChecks(const HPolyhedron& other, double tol) const;
