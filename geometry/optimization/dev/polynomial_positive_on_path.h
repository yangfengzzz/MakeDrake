...
public:
    ...
    ParametrizedPolynomialPositiveOnUnitInterval(const symbolic::Polynomial& poly,
    ...
    void AddPositivityConstraintToProgram(const symbolic::Environment& env, solvers::MathematicalProgram* prog) const;
    ...
    const solvers::MathematicalProgram& get_psatz_variables_and_psd_constraints() const {
