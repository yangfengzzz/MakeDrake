...
public:
    ...
    DRAKE_DEPRECATED("2024-08-01", "Projection has moved to `ConvexSet`; use `Projection()` instead.")
...
private:
    ...
    std::vector<std::optional<double>> DoProjectionShortcut(const Eigen::Ref<const Eigen::MatrixXd>& points,
