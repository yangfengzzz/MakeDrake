...
public:
    ...
    SamePointConstraint(const multibody::MultibodyPlant<double>* plant, const systems::Context<double>& context);
...
private:
    ...
    std::unique_ptr<multibody::MultibodyPlant<symbolic::Expression>> symbolic_plant_{nullptr};
    std::unique_ptr<systems::Context<symbolic::Expression>> symbolic_context_{nullptr};
};
...
public:
    ClosestCollisionProgram(std::shared_ptr<SamePointConstraint> same_point_constraint,
