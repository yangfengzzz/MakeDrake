...
private:
    ...
    Eigen::VectorXd StackAndMaybeTransform(const std::vector<Eigen::VectorXd>& points) const;
    ...
    std::optional<Eigen::ColPivHouseholderQR<Eigen::MatrixXd>> A_decomp_{std::nullopt};
