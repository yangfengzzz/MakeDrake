...
public:
    ...
    DenseSuperNodalSolver(const std::vector<MatrixX<double>>* A, const BlockSparseMatrix<double>* J);

private:
    // Implementations of SuperNodalSolver NVIs. NVIs perform basic checks.
    bool DoSetWeightMatrix(const std::vector<Eigen::MatrixXd>& block_diagonal_G) final;
