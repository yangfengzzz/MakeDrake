...
public:
    ...
    SapFrictionConeConstraintData(const T& mu, const T& Rt, const T& Rn, const T& vn_hat);
...
public:
    ...
    //@{
    SapFrictionConeConstraint& operator=(const SapFrictionConeConstraint&) = delete;
    ...
    SapFrictionConeConstraint(ContactConfiguration<T> configuration, SapConstraintJacobian<T> J, Parameters parameters);
    ...
    const ContactConfiguration<T>& configuration() const { return configuration_; }
...
private:
    ...
    std::unique_ptr<SapConstraint<T>> DoClone() const final {
        return std::unique_ptr<SapFrictionConeConstraint<T>>(new SapFrictionConeConstraint<T>(*this));
    }
    ...
    */
    static ContactMode CalcContactMode(const T& mu, const T& mu_hat, const T& yr, const T& yn);
    ...
    void ProjectImpulse(const SapFrictionConeConstraintData<T>& data, Vector3<T>* gamma) const;
