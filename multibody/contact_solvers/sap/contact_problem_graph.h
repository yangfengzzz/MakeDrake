...
public:
    ...
    public:
        ...
        ConstraintCluster& AddConstraint(int constraint_index, int num_constraint_equations);

        const SortedPair<int>& cliques() const { return cliques_; }
        int num_constraints() const { return ssize(constraint_index_); }
        int num_total_constraint_equations() const { return num_constraint_equations_; }
        const std::vector<int>& constraint_index() const { return constraint_index_; }
        const std::vector<int>& constraint_num_equations() const { return constraint_num_equations_; }
    ...
    int AddConstraint(int first_clique, int second_clique, int num_constraint_equations);
    ...
    /* Returns the permutation of participating cliques.
     ...
     by AddConstraint(). */
    const PartialPermutation& participating_cliques() const { return participating_cliques_; }
