...
GTEST_TEST(MinimumDegreeOrderingTest, UpdateExternalDegree) {
    Node n4{.degree = 0, .size = 40, .index = 4, .A = {}, .E = {}, .L = {6, 7, 8}};
    Node n5{.degree = 0, .size = 50, .index = 5, .A = {}, .E = {}, .L = {6, 7, 9}};
    ...
    Node n10{.degree = 0, .size = 100, .index = 10, .A = {7, 8, 9}, .E = {}, .L = {}};
...
GTEST_TEST(MinimumDegreeOrderingTest, ComputeMinimumDegreeOrderingWithPriority) {
    std::vector<std::vector<int>> sparsity;
    sparsity.emplace_back(std::vector<int>{0, 3, 5});
    sparsity.emplace_back(std::vector<int>{1, 4, 5, 8});
    sparsity.emplace_back(std::vector<int>{2, 4, 5, 6});
    ...
    std::vector<int> block_sizes(10, 2);
    BlockSparsityPattern block_pattern(block_sizes, sparsity);
    const std::vector<int> result = ComputeMinimumDegreeOrdering(block_pattern, {0, 2, 4, 6, 8});
...
GTEST_TEST(MinimumDegreeOrderingTest, SymbolicCholeskyFactor) {
    ...
    const BlockSparsityPattern L_block_pattern = SymbolicCholeskyFactor(A_block_pattern);
...
GTEST_TEST(BlockSparseCholeskySolverTest, ConcatenateMdOrderingWithinGroup) {
    ...
    const std::vector<int> result = CalcAndConcatenateMdOrderingWithinGroup(block_pattern, v1);
