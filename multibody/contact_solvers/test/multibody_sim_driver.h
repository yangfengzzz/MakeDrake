...
public:
    ...
    // when/if needed.
    std::vector<double> GetDynamicFrictionCoefficients(const RigidBody<double>& body) const;
...
private:
    void SetPointContactParameters(const RigidBody<double>& body, double stiffness, double damping);
