...
#include "multibody/contact_solvers/contact_solver.h"
...
public:
    ...
    void set_parameters(const PgsSolverParameters& parameters) { parameters_ = parameters; }
...
private:
    ...
    void PreProcessData(const SystemDynamicsData<T>& dynamics_data, const PointContactData<T>& contact_data);
    ...
    */
    bool VerifyConvergenceCriteria(int num_contacts,
                                   const VectorX<T>& vc,
