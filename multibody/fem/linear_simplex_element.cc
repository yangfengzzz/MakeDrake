...
typename LinearSimplexElement<T,
        ...
        template ArrayNumSamples<typename IsoparametricElement<
                ...
                LinearSimplexElementTraits<T,
                                           natural_dimension_at_compile_time,
                                           spatial_dimension_at_compile_time,
                                           num_sample_locations_at_compile_time>>::GradientInSpatialCoordinates>
        LinearSimplexElement<T,
                             natural_dimension_at_compile_time,
                             spatial_dimension_at_compile_time,
                             num_sample_locations_at_compile_time>::
...
typename LinearSimplexElement<T,
        ...
        template ArrayNumSamples<typename IsoparametricElement<
                ...
                LinearSimplexElementTraits<T,
                                           natural_dimension_at_compile_time,
                                           spatial_dimension_at_compile_time,
                                           num_sample_locations_at_compile_time>>::JacobianMatrix>
        LinearSimplexElement<T,
                             natural_dimension_at_compile_time,
                             spatial_dimension_at_compile_time,
                             num_sample_locations_at_compile_time>::
                CalcJacobian(const Eigen::Ref<const Eigen::Matrix<T, spatial_dimension, num_nodes>>& xa) const {
...
typename LinearSimplexElement<T,
        ...
        template ArrayNumSamples<typename IsoparametricElement<
                ...
                LinearSimplexElementTraits<T,
                                           natural_dimension_at_compile_time,
                                           spatial_dimension_at_compile_time,
                                           num_sample_locations_at_compile_time>>::PseudoinverseJacobianMatrix>
        LinearSimplexElement<T,
                             natural_dimension_at_compile_time,
                             spatial_dimension_at_compile_time,
                             num_sample_locations_at_compile_time>::
                CalcJacobianPseudoinverse(const ArrayNumSamples<JacobianMatrix>& jacobian) const {
...
typename LinearSimplexElement<T,
                              ...
                              spatial_dimension_at_compile_time,
                              num_sample_locations_at_compile_time>::
        template ArrayNumSamples<typename LinearSimplexElement<T,
                                                               natural_dimension_at_compile_time,
                                                               spatial_dimension_at_compile_time,
        ...
        LinearSimplexElement<T,
                             ...
                             spatial_dimension_at_compile_time,
                             num_sample_locations_at_compile_time>::
                CalcShapeFunctions(const ArrayNumSamples<Vector<double, natural_dimension>>& locations) const {
...
template <typename T,
          ...
          int spatial_dimension_at_compile_time,
          int num_sample_locations_at_compile_time>
const typename LinearSimplexElement<T,
                                    natural_dimension_at_compile_time,
                                    spatial_dimension_at_compile_time,
                                    num_sample_locations_at_compile_time>::
        template ArrayNumSamples<
                typename LinearSimplexElement<T,
                                              natural_dimension_at_compile_time,
                                              spatial_dimension_at_compile_time,
        ...
        LinearSimplexElement<T,
                             natural_dimension_at_compile_time,
                             spatial_dimension_at_compile_time,
                             num_sample_locations_at_compile_time>::CalcGradientInParentCoordinates() {
