...
public:
    ...
    FemStateSystem(const VectorX<T>& model_q, const VectorX<T>& model_v, const VectorX<T>& model_a);
    ...
    systems::DiscreteStateIndex fem_previous_step_position_index() const { return q0_index_; }
    systems::DiscreteStateIndex fem_velocity_index() const { return v_index_; }
    systems::DiscreteStateIndex fem_acceleration_index() const { return a_index_; }
