...
template <typename T,
          int natural_dimension_at_compile_time,
...
struct LinearSimplexElementTraits {
    ...
    static constexpr int num_sample_locations = num_sample_locations_at_compile_time;
    static constexpr int num_nodes = num_linear_simplex_element_nodes<natural_dimension>();
};
...
class LinearSimplexElement
    : public IsoparametricElement<LinearSimplexElement<T,
                                                       natural_dimension_at_compile_time,
                                                       spatial_dimension_at_compile_time,
                                                       num_sample_locations_at_compile_time>,
                                  LinearSimplexElementTraits<T,
                                                             natural_dimension_at_compile_time,
                                                             spatial_dimension_at_compile_time,
                                                             num_sample_locations_at_compile_time>> {
public:
    ...
    using Element = LinearSimplexElement<T,
                                         natural_dimension_at_compile_time,
                                         spatial_dimension_at_compile_time,
                                         num_sample_locations_at_compile_time>;
    using Traits = LinearSimplexElementTraits<T,
                                              natural_dimension_at_compile_time,
                                              spatial_dimension_at_compile_time,
                                              num_sample_locations_at_compile_time>;
    ...
    using GradientInParentCoordinates = typename Base::GradientInParentCoordinates;
    using GradientInSpatialCoordinates = typename Base::GradientInSpatialCoordinates;
    using JacobianMatrix = typename Base::JacobianMatrix;
    using PseudoinverseJacobianMatrix = typename Base::PseudoinverseJacobianMatrix;
    ...
    explicit LinearSimplexElement(const ArrayNumSamples<Vector<double, natural_dimension>>& locations)
        : Base(locations, CalcShapeFunctions(locations), CalcGradientInParentCoordinates()) {}
...
private:
    ...
    static const ArrayNumSamples<GradientInParentCoordinates> CalcGradientInParentCoordinates();
};
