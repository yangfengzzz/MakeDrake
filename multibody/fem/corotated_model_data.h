...
class CorotatedModelData : public DeformationGradientData<CorotatedModelData<T, num_locations>> {
public:
    ...
    /* Returns the JF⁻ᵀ. */
    const std::array<Matrix3<T>, num_locations>& JFinvT() const { return JFinvT_; }
