...
template <>
std::pair<SimplexGaussianQuadrature<2, 1>::LocationsType, SimplexGaussianQuadrature<2, 1>::WeightsType>
...
template <>
std::pair<SimplexGaussianQuadrature<2, 2>::LocationsType, SimplexGaussianQuadrature<2, 2>::WeightsType>
...
template <>
std::pair<SimplexGaussianQuadrature<2, 3>::LocationsType, SimplexGaussianQuadrature<2, 3>::WeightsType>
...
template <>
std::pair<SimplexGaussianQuadrature<3, 1>::LocationsType, SimplexGaussianQuadrature<3, 1>::WeightsType>
...
template <>
std::pair<SimplexGaussianQuadrature<3, 2>::LocationsType, SimplexGaussianQuadrature<3, 2>::WeightsType>
...
template <>
std::pair<SimplexGaussianQuadrature<3, 3>::LocationsType, SimplexGaussianQuadrature<3, 3>::WeightsType>
SimplexGaussianQuadrature<3, 3>::ComputePointsAndWeights() {
    ...
    points[4] = {b, b, b};
    /* For a unit tetrahedron, area = 1/6. */
    WeightsType weights = {{-2.0 / 15.0, 3.0 / 40.0, 3.0 / 40.0, 3.0 / 40.0, 3.0 / 40.0}};
    return make_pair(std::move(points), std::move(weights));
}
}  // namespace internal
}  // namespace fem
