...
inline auto SpanningForest::mobods(MobodIndex mobod_index) const -> const Mobod& {
...
inline const std::vector<BodyIndex>& SpanningForest::mobod_to_links(MobodIndex mobod_index) const {
...
inline auto SpanningForest::loop_constraints(LoopConstraintIndex index) const -> const LoopConstraint& {
