...
struct PointContactVisualizerItem {
    PointContactVisualizerItem(std::string body_A_,
                               std::string body_B_,
...
public:
    ...
    PointContactVisualizer(std::shared_ptr<geometry::Meshcat> meshcat, ContactVisualizerParams params);
    ...
    void Update(double time, const std::vector<PointContactVisualizerItem>& items);
