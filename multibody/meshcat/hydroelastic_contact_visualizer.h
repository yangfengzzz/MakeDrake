...
struct HydroelasticContactVisualizerItem {
    HydroelasticContactVisualizerItem(std::string body_A_,
                                      std::string body_B_,
...
public:
    ...
    @pre meshcat != nullptr
    */
    HydroelasticContactVisualizer(std::shared_ptr<geometry::Meshcat> meshcat, ContactVisualizerParams params);
    ...
    void Update(double time, const std::vector<HydroelasticContactVisualizerItem>& items);
