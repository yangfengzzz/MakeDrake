...
public:
    ...
    explicit PhysicalModel(MultibodyPlant<T>* owning_plant) : owning_plant_(owning_plant) {
    ...
    PhysicalModelPointerVariant<T> ToPhysicalModelPointerVariant() const { return DoToPhysicalModelPointerVariant(); }
