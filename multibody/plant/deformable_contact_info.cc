...
template <typename T>
DeformableContactInfo<T>::DeformableContactInfo(GeometryId id_A,
                                                GeometryId id_B,
...
DRAKE_DEFINE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::multibody::DeformableContactInfo);
