...
public:
    ...
    const geometry::PolygonSurfaceMesh<T>& contact_mesh() const { return contact_mesh_W_; }
    ...
    const std::vector<DeformableContactPointData<T>>& contact_point_data() const { return contact_point_data_; }
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::multibody::DeformableContactInfo);
