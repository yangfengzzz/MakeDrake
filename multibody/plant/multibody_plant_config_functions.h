...
AddMultibodyPlantSceneGraphResult<double> AddMultibodyPlant(const MultibodyPlantConfig& config,
...
std::string GetStringFromDiscreteContactSolver(DiscreteContactSolver discrete_contact_solver);

DiscreteContactApproximation GetDiscreteContactApproximationFromString(std::string_view discrete_contact_approximation);
std::string GetStringFromDiscreteContactApproximation(DiscreteContactApproximation discrete_contact_approximation);
...
// overview.
// @throws std::exception if an invalid string is passed in.
geometry::HydroelasticContactRepresentation GetContactSurfaceRepresentationFromString(
