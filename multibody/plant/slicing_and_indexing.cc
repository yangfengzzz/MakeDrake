...
contact_solvers::internal::MatrixBlock<T> ExcludeCols(const contact_solvers::internal::MatrixBlock<T>& M,
    ...
    return contact_solvers::internal::MatrixBlock<T>(ExcludeCols(M.MakeDenseMatrix(), indices));
}
...
DRAKE_DEFINE_FUNCTION_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(
        (&SelectRowsCols<T>,
         ...
         &SelectCols<T>,
         &ExpandRows<T>,
         static_cast<MatrixX<T> (*)(const MatrixX<T>&, const std::vector<int>&)>(&ExcludeCols),
         static_cast<contact_solvers::internal::MatrixBlock<T> (*)(const contact_solvers::internal::MatrixBlock<T>&,
