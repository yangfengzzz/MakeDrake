...
public:
    ...
    const Eigen::Quaterniond& get_initial_quat_NB() const { return initial_quat_NB_; }
    ...
    const Eigen::Vector3d& get_initial_p_NoBcm_N() const { return initial_p_NoBcm_N_; }
    ...
    void set_initial_quat_NB(const Eigen::Quaterniond& quat_NB) { initial_quat_NB_ = quat_NB; }
    void set_initial_w_NB_B(const Eigen::Vector3d& w_NB_B) { initial_w_NB_B_ = w_NB_B; }
    void set_initial_p_NoBcm_N(const Eigen::Vector3d& p_NoBcm_N) { initial_p_NoBcm_N_ = p_NoBcm_N; }
    void set_initial_v_NBcm_B(const Eigen::Vector3d& v_NBcm_B) { initial_v_NBcm_B_ = v_NBcm_B; }
    ...
    std::tuple<Eigen::Quaterniond, Eigen::Vector4d, Eigen::Vector3d, Eigen::Vector3d>
    ...
    std::tuple<Eigen::Vector3d, Eigen::Vector3d, Eigen::Vector3d> CalculateExactTranslationalSolution(
...
private:
    ...
    // download: https://ecommons.cornell.edu/handle/1813/637
    std::tuple<Eigen::Quaterniond, Eigen::Vector3d, Eigen::Vector3d> CalculateExactRotationalSolutionABInitiallyAligned(
            const double t) const;
