...
#include "multibody/benchmarks/chaotic_babyboot/MG/MG_chaotic_babyboot_auto_generated.h"
...
void CompareExpectedSolutionVsActualSolution(const ChaoticBabybootData& babyboot_data_expected) {
