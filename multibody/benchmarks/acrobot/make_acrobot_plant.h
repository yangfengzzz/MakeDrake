...
public:
    ...
    const std::string& shoulder_joint_name() const { return shoulder_joint_name_; }
...
std::unique_ptr<MultibodyPlant<double>> MakeAcrobotPlant(const AcrobotParameters& default_parameters,
                                                         bool finalize,
