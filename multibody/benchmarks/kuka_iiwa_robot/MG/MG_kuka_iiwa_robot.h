...
#include "multibody/benchmarks/kuka_iiwa_robot/MG/MG_kuka_iiwa_robot_auto_generated.h"
...
public:
    ...
    explicit MGKukaIIwaRobot(double gravity) {
        static_assert(std::is_same_v<T, double>, "This class only supports T = double.");
        set_gravity(gravity);
    }
    ...
    std::tuple<SpatialForce<double>,
               ...
               SpatialForce<double>,
               SpatialForce<double>>
    CalcJointReactionForcesExpressedInMobilizer(const Eigen::Ref<const VectorX<T>>& q,
                                                const Eigen::Ref<const VectorX<T>>& qDt,
                                                const Eigen::Ref<const VectorX<T>>& qDDt) const;
    ...
    std::tuple<SpatialForce<double>,
               ...
               SpatialForce<double>,
               SpatialForce<double>>
    CalcJointReactionForcesExpressedInWorld(const Eigen::Ref<const VectorX<T>>& q,
                                            const Eigen::Ref<const VectorX<T>>& qDt,
                                            const Eigen::Ref<const VectorX<T>>& qDDt) const;
    ...
    Vector<double, 7> CalcRevoluteMotorZTorques(const Eigen::Ref<const VectorX<T>>& q,
                                                const Eigen::Ref<const VectorX<T>>& qDt,
                                                const Eigen::Ref<const VectorX<T>>& qDDt) const;
