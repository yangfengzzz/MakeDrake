...
public:
    ...
    double IAzz = 0.0123, IBxx = 0.0305, IByy = 0.0304, IBzz = 0.011, ICxx = 0.025, ICyy = 0.0238, ICzz = 0.0076,
           IDxx = 0.017, IDyy = 0.0164, IDzz = 0.006, IExx = 0.01, IEyy = 0.0087, IEzz = 0.00449, IFxx = 0.0049,
    ...
    double fAx, fAy, fAz, fBx, fBy, fBz, fCx, fCy, fCz, fDx, fDy, fDz, fEx, fEy, fEz, fFx, fFy, fFz, fGx, fGy, fGz, tAx,
            tAy, tAz, tBx, tBy, tBz, tCx, tCy, tCz, tDx, tDy, tDz, tEx, tEy, tEz, tFx, tFy, tFz, tGx, tGy, tGz;
    double z[251], R_NG[3][3], p_NoGo_N[3], w_NG_N[3], v_NGo_N[3], alpha_NG_N[3], a_NGo_N[3], fA[3], tA[3], fB[3],
            tB[3], fC[3], tC[3], fD[3], tD[3], fE[3], tE[3], fF[3], tF[3], fG[3], tG[3], SpatialForce_A_N[6],
            SpatialForce_B_N[6], SpatialForce_C_N[6], SpatialForce_D_N[6], SpatialForce_E_N[6], SpatialForce_F_N[6],
            SpatialForce_G_N[6];
};
