...
public:
    ...
    // types.
    explicit RobotModel(const RobotModelConfig& config, bool add_visualization = false)
    ...
    const multibody::contact_solvers::internal::SapContactProblem<T>& EvalContactProblem(const VectorX<T>& x0)
