...
public:
    ...
    explicit ForceElement(ModelInstanceIndex model_instance) : MultibodyElement<T>(model_instance) {}

    ~ForceElement() override;

    /// Returns this element's unique index.
    ForceElementIndex index() const { return this->template index_impl<ForceElementIndex>(); }
    ...
    std::unique_ptr<ForceElement<ToScalar>> CloneToScalar(const internal::MultibodyTree<ToScalar>& cloned_tree) const {
