...
std::unique_ptr<Joint<ToScalar>> PrismaticJoint<T>::TemplatedDoCloneToScalar(
    ...
    auto joint_clone = std::make_unique<PrismaticJoint<ToScalar>>(
            this->name(), frame_on_parent_body_clone, frame_on_child_body_clone, this->translation_axis(),
            this->position_lower_limit(), this->position_upper_limit(), this->default_damping());
...
DRAKE_DEFINE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::multibody::PrismaticJoint);
