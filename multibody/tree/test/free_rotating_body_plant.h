...
public:
    ...
    /// in the world frame W.
    void set_angular_velocity(systems::Context<T>* context, const Vector3<T>& w_WB) const;
...
private:
    const internal::MultibodyTree<T>& tree() const { return internal::GetInternalTree(*this); }
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::multibody::test::FreeRotatingBodyPlant);
