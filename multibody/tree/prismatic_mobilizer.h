...
public:
    ...
    const PrismaticMobilizer<T>& SetTranslation(systems::Context<T>* context, const T& translation) const;
    ...
    // @returns a constant reference to `this` mobilizer.
    const PrismaticMobilizer<T>& SetTranslationRate(systems::Context<T>* context, const T& translation_dot) const;
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::multibody::internal::PrismaticMobilizer);
