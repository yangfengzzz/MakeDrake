...
private:
    ...
    const internal::WeldMobilizer<T>* get_mobilizer() const {
        ...
        const internal::WeldMobilizer<T>* mobilizer =
                dynamic_cast<const internal::WeldMobilizer<T>*>(this->get_implementation().mobilizer);
    ...
    internal::WeldMobilizer<T>* get_mutable_mobilizer() {
        DRAKE_DEMAND(this->get_implementation().has_mobilizer());
        auto* mobilizer = dynamic_cast<internal::WeldMobilizer<T>*>(this->get_implementation().mobilizer);
        DRAKE_DEMAND(mobilizer != nullptr);
        return mobilizer;
    }
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::multibody::WeldJoint);
