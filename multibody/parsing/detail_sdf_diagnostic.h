...
public:
    ...
    void Warning(const sdf::ElementConstPtr element, const std::string& message) const;

    // Issues an error for an ElementConstPtr.
    void Error(const sdf::ElementConstPtr element, const std::string& message) const;
    ...
    drake::internal::DiagnosticPolicy MakePolicyForNode(const sdf::Element& element) const;

    // Warn about spec-documented elements ignored by Drake.
    void WarnUnsupportedElement(const sdf::ElementConstPtr element, const std::string& tag) const;

    // Warn about spec-documented attributes ignored by Drake.
    void WarnUnsupportedAttribute(const sdf::ElementConstPtr element, const std::string& attribute) const;
...
private:
    ...
    drake::internal::DiagnosticDetail MakeDetail(const sdf::Element& element, const std::string& message) const;
