...
class MultibodyPlantLinkTests : public testing::TestWithParam<test::ModelLoadFunction> {
public:
...
TEST_P(MultibodyPlantLinkTests, LinksWithCollisions) {
    ...
    EXPECT_TRUE(scene_graph_.model_inspector()
                        ...
                        ->GetProperty<CoulombFriction<double>>("material", "coulomb_friction") ==
...
INSTANTIATE_TEST_SUITE_P(SdfMultibodyPlantLinkTests, MultibodyPlantLinkTests, ::testing::Values(test::LoadFromSdf));

INSTANTIATE_TEST_SUITE_P(UrdfMultibodyPlantLinkTests, MultibodyPlantLinkTests, ::testing::Values(test::LoadFromUrdf));
