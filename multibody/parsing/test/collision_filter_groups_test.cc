...
GTEST_TEST(CollisionFilterGroups, Convert) {
    ...
    CollisionFilterGroupsImpl<double> double_groups = int_groups1.template Convert<double>(int_to_double);

    CollisionFilterGroupsImpl<int> int_groups2 = double_groups.template Convert<int>(double_to_int);
