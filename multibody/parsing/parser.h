...
public:
    ...
    ///   May be nullptr.
    explicit Parser(MultibodyPlant<double>* plant, geometry::SceneGraph<double>* scene_graph = nullptr);
    ...
    const CollisionFilterGroups& collision_filter_groups() const { return collision_filter_groups_; }
...
private:
    ...
    void ResolveCollisionFilterGroupsFromCompositeParse(internal::CollisionFilterGroupResolver* resolver);
