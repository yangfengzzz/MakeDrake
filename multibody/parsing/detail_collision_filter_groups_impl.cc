...
template <typename T>
bool CollisionFilterGroupsImpl<T>::operator==(const CollisionFilterGroupsImpl&) const = default;

template <typename T>
void CollisionFilterGroupsImpl<T>::AddGroup(const T& name, const std::set<T>& members) {
...
template <typename T>
void CollisionFilterGroupsImpl<T>::Merge(const CollisionFilterGroupsImpl& source) {
...
template <typename T>
template <typename U>
auto CollisionFilterGroupsImpl<T>::Convert(const std::function<U(const T&)>& name_converter) const
...
template auto CollisionFilterGroupsImpl<std::string>::Convert(
        const std::function<InstancedName(const std::string&)>& name_converter) const
        -> CollisionFilterGroupsImpl<InstancedName>;
template auto CollisionFilterGroupsImpl<InstancedName>::Convert(
        const std::function<std::string(const InstancedName&)>& name_converter) const
...
template auto CollisionFilterGroupsImpl<int>::Convert(const std::function<double(const int&)>& name_converter) const
        -> CollisionFilterGroupsImpl<double>;
template auto CollisionFilterGroupsImpl<double>::Convert(const std::function<int(const double&)>& name_converter) const
