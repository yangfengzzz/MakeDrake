...
public:
    ...
    */
    ...
    double distance_bound() const { return minimum_value_constraint_->minimum_value_lower(); }

    /** Getter for the influence distance. */
    double influence_distance() const { return minimum_value_constraint_->influence_value(); }
...
private:
    ...
    void CheckBounds(double minimum_distance_upper, double influence_distance) const;
    ...
    std::unique_ptr<solvers::MinimumValueLowerBoundConstraint> minimum_value_constraint_{};
