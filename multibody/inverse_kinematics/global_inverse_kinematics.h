...
public:
    ...
    struct Options {
        ...
        solvers::MixedIntegerRotationConstraintGenerator::Approach approach{
                solvers::MixedIntegerRotationConstraintGenerator::Approach::kBilinearMcCormick};
        solvers::IntervalBinning interval_binning{solvers::IntervalBinning::kLogarithmic};
     ...
     */
    explicit GlobalInverseKinematics(const MultibodyPlant<double>& plant, const Options& options = Options());
    ...
    solvers::Binding<solvers::LinearConstraint> AddWorldOrientationConstraint(
            BodyIndex body_index, const Eigen::Quaterniond& desired_orientation, double angle_tol);
