...
public:
    ...
    */
    ...
    double distance_bound() const { return minimum_value_constraint_->minimum_value_upper(); }
...
private:
    ...
    std::unique_ptr<solvers::MinimumValueUpperBoundConstraint> minimum_value_constraint_{};
