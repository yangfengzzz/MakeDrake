...
class DifferentialInverseKinematicsIntegrator : public systems::LeafSystem<double> {
public:
    ...
    @pre frame_E != frame_A.
    */
    DifferentialInverseKinematicsIntegrator(const MultibodyPlant<double>& robot,
    ...
    */
    ...
    void SetPositions(systems::Context<double>* context, const Eigen::Ref<const Eigen::VectorXd>& positions) const;

    /** Provides X_AE as a function of the joint position set in `context`. */
    math::RigidTransformd ForwardKinematics(const systems::Context<double>& context) const;
...
private:
    ...
    void UpdateRobotContext(const systems::Context<double>& context, systems::Context<double>* robot_context) const;

    // Calls DoDifferentialInverseKinematics and performs one integration step.
    systems::EventStatus Integrate(const systems::Context<double>& context,
                                   systems::DiscreteValues<double>* discrete_state) const;

    // Outputs the current position value.
    void CopyPositionsOut(const systems::Context<double>& context, systems::BasicVector<double>* output) const;
