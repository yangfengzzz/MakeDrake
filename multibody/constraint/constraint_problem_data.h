...
template <class T>
using ConstraintAccelProblemData DRAKE_DEPRECATED("2024-09-01", "This class is being removed from Drake.") =
        internal::ConstraintAccelProblemData<T>;

template <class T>
using ConstraintVelProblemData DRAKE_DEPRECATED("2024-09-01", "This class is being removed from Drake.") =
