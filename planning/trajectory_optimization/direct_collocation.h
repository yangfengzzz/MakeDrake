...
private:
    ...
    const std::variant<systems::InputPortSelection, systems::InputPortIndex> input_port_index_;
...
protected:
    DirectCollocationConstraint(std::pair<std::unique_ptr<systems::System<AutoDiffXd>>,
                                          std::unique_ptr<systems::Context<AutoDiffXd>>> owned_pair,
...
private:
    void CalcDynamics(const AutoDiffVecXd& state,
