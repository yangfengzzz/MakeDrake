...
#include "multibody/parsing/model_directives.h"
...
struct CollisionCheckerTestConfigurationData {
    CollisionCheckerTestConfigurationData() {
        ...
        configs = {q1, q2, q3, q4};
        edges = {std::make_pair(q1, q2), std::make_pair(q2, q3), std::make_pair(q3, q2), std::make_pair(q3, q4)};
    }
...
class CollisionCheckerAbstractTestSuite : public testing::TestWithParam<CollisionCheckerTestParams> {
protected:
    void TestDiscreteQueries(const CollisionCheckerTestParams& params, Parallelism parallelism);
    void TestDistanceQueries(const CollisionCheckerTestParams& params, Parallelism parallelism);
