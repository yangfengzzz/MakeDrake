...
private:
    ...
    using MaybeParser = std::conditional_t<std::is_same_v<T, double>, multibody::Parser, void*>;
    MaybeParser parser_;
};
...
DRAKE_DECLARE_CLASS_TEMPLATE_INSTANTIATIONS_ON_DEFAULT_SCALARS(class ::drake::planning::RobotDiagramBuilder);
