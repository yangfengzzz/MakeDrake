#include "planning/graph_algorithms/max_clique_solver_via_greedy.h"
...
// the graph.
void TestMaxCliqueViaGreedy(const Eigen::Ref<const Eigen::SparseMatrix<bool>>& adjacency_matrix,
...
GTEST_TEST(MaxCliqueSolverViaGreedyTest, FullyConnectedPlusFullBipartiteGraph) {
    ...
    std::vector<VectorX<bool>> possible_solutions{solution1, solution2, solution3, solution4, solution5,
