...
public:
     ...
     */
    [[nodiscard]] VectorX<bool> SolveMaxClique(const Eigen::SparseMatrix<bool>& adjacency_matrix) const;
...
private:
    virtual VectorX<bool> DoSolveMaxClique(const Eigen::SparseMatrix<bool>& adjacency_matrix) const = 0;
};
