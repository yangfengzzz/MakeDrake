...
class LinearDistanceAndInterpolationProvider final : public DistanceAndInterpolationProvider {
public:
    ...
    explicit LinearDistanceAndInterpolationProvider(const multibody::MultibodyPlant<double>& plant);
    ...
    const std::vector<int>& quaternion_dof_start_indices() const { return quaternion_dof_start_indices_; }
