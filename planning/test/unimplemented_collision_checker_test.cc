...
public:
    MyUnimplementedCollisionChecker(CollisionCheckerParams params, bool supports_parallel_checking)
        : UnimplementedCollisionChecker(std::move(params), supports_parallel_checking) {
